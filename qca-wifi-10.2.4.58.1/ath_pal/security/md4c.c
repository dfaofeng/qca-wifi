...
static void MD4Transform PROTO_LIST ((uint32 [4], const unsigned char [64]));
static void Encode PROTO_LIST
  ((unsigned char *, uint32 *, unsigned int));
static void Decode PROTO_LIST
  ((uint32 *, const unsigned char *, unsigned int));
 ...
 */
void MD4_Init (MD4_CTX *context)  /* context */
{
...
/* MD4 padding. */
void MD4Pad (MD4_CTX *context)          /* context */
{
...
)
{
   ...
   */
  os_memset ((POINTER)context, 0, sizeof (*context));
}
...
)
{
  ...
  /* Zeroize sensitive information.
   */
  os_memset ((POINTER)x, 0, sizeof (x));
}
