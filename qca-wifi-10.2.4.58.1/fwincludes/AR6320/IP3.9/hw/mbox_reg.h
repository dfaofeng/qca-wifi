...
#define MBOX_BURST_CONTROL_ADDRESS WLAN_MBOX_BURST_CONTROL_ADDRESS
#define MBOX_BURST_CONTROL_OFFSET WLAN_MBOX_BURST_CONTROL_OFFSET
#define MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_MSB WLAN_MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_MSB
#define MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_LSB WLAN_MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_LSB
#define MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_MASK WLAN_MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_MASK
#define MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_GET(x) WLAN_MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_GET(x)
#define MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_SET(x) WLAN_MBOX_BURST_CONTROL_RD_ADDR_ALIGN_EN_SET(x)
#define MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_MSB WLAN_MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_MSB
#define MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_LSB WLAN_MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_LSB
#define MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_MASK WLAN_MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_MASK
#define MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_GET(x) WLAN_MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_GET(x)
#define MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_SET(x) WLAN_MBOX_BURST_CONTROL_WR_ADDR_ALIGN_EN_SET(x)
