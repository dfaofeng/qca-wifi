...
// File:       ./soc_core_reg.h                                                
// Creator:    tcai                                                            
// Time:       Thursday Nov 17, 2011 [11:27:38 am]                             
//                                                                             
// Path:       /localtrees/tcai/tcai_local/chips/hera/dev/rtl/wlan/soc_core_reg/blueprint
// Arguments:  /cad/denali/blueprint/3.7.4//Linux-64bit/blueprint -odir .      
//             -codegen ath_vrh.codegen -ath_vrh -ch -Wdesc -I                 
//             /localtrees/tcai/tcai_local/chips/hera/dev/blueprint/sysconfig  
//             soc_core_reg.rdl                                                
//                                                                             
// Sources:    /localtrees/tcai/tcai_local/chips/hera/dev/rtl/wlan/soc_core_reg/blueprint/soc_core_reg.rdl
//             /localtrees/tcai/tcai_local/chips/hera/dev/env/blueprint/ath_vrh.pm
//                                                                             
...
// SW modifiable bits
#define WLAN_AHB_ADDR_ERROR_STATUS_SW_MASK                           0x40ffffff
// bits defined at reset
...
#define AXI_SPOOFER_BRIDGE_EN_MSB                                    2
#define AXI_SPOOFER_BRIDGE_EN_LSB                                    2
#define AXI_SPOOFER_BRIDGE_EN_MASK                                   0x00000004
#define AXI_SPOOFER_BRIDGE_EN_GET(x)                                 (((x) & AXI_SPOOFER_BRIDGE_EN_MASK) >> AXI_SPOOFER_BRIDGE_EN_LSB)
#define AXI_SPOOFER_BRIDGE_EN_SET(x)                                 (((x) << AXI_SPOOFER_BRIDGE_EN_LSB) & AXI_SPOOFER_BRIDGE_EN_MASK)
#define AXI_SPOOFER_BRIDGE_EN_RESET                                  0x0 // 0
...
// SW modifiable bits
#define AXI_SPOOFER_SW_MASK                                          0x0000000f
// bits defined at reset
