...
// Creator:    knam                                                            
// Time:       Tuesday Jan 17, 2012 [3:19:31 pm]                               
//                                                                             
// Path:       /trees/knam/knam-dev/ip/athr/wifi/R1_IP3/rtl/mac_coex/blueprint 
// Arguments:  /cad/denali/blueprint/3.7.3//Linux/blueprint -odir . -codegen   
//             ath_vrh.codegen -ath_vrh -ch -Wdesc wlan_coex_reg.rdl           
//                                                                             
// Sources:    /trees/knam/knam-dev/ip/athr/wifi/R1_IP3/rtl/mac_coex/blueprint/wlan_coex_reg.rdl
...
#define BTCOEX_CTRL_USE_1_CHAIN_FOR_ACK_SET(x)                       (((x) << BTCOEX_CTRL_USE_1_CHAIN_FOR_ACK_LSB) & BTCOEX_CTRL_USE_1_CHAIN_FOR_ACK_MASK)
#define BTCOEX_CTRL_USE_1_CHAIN_FOR_ACK_RESET                        0x0 // 0
...
#define BTCOEX_CTRL_USE_1_CHAIN_FOR_BCN_SET(x)                       (((x) << BTCOEX_CTRL_USE_1_CHAIN_FOR_BCN_LSB) & BTCOEX_CTRL_USE_1_CHAIN_FOR_BCN_MASK)
#define BTCOEX_CTRL_USE_1_CHAIN_FOR_BCN_RESET                        0x0 // 0
...
#define BTCOEX_CTRL_RX_CHAIN_MASK_SET(x)                             (((x) << BTCOEX_CTRL_RX_CHAIN_MASK_LSB) & BTCOEX_CTRL_RX_CHAIN_MASK_MASK)
#define BTCOEX_CTRL_RX_CHAIN_MASK_RESET                              0x0 // 0
