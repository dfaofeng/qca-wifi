...
#define SUR_PD_CSB_REG_ADDRESS                   0x0000002c
#define SUR_PD_CSB_REG_OFFSET                    0x0000002c
...
#define SUR_PD_CSB_REG_V_SET(x)                  (((x) << SUR_PD_CSB_REG_V_LSB) & SUR_PD_CSB_REG_V_MASK)

#define SUP_PS_CSB_REG_ADDRESS                   0x00000030
#define SUP_PS_CSB_REG_OFFSET                    0x00000030
...
#define SUP_PS_CSB_REG_V_SET(x)                  (((x) << SUP_PS_CSB_REG_V_LSB) & SUP_PS_CSB_REG_V_MASK)
...
#define EFUSE_INTF2_ADDRESS                      0x00001800
#define EFUSE_INTF2_OFFSET                       0x00001800
...
#define EFUSE_INTF2_R_SET(x)                     (((x) << EFUSE_INTF2_R_LSB) & EFUSE_INTF2_R_MASK)
...
typedef struct efuse_reg_reg_s {
  ...
  volatile unsigned int sur_pd_csb_reg;
  volatile unsigned int sup_ps_csb_reg;
  unsigned char pad0[1996]; /* pad to 0x800 */
  volatile unsigned int efuse_intf0[512];
  volatile unsigned int efuse_intf1[512];
  volatile unsigned int efuse_intf2[512];
} efuse_reg_reg_t;
#endif /* __ASSEMBLER__ */
