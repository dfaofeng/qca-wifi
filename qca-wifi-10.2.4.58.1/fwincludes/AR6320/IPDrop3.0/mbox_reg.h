...
#define MBOX_FIFO_STATUS_RX_EOM_MSB WLAN_MBOX_FIFO_STATUS_RX_EOM_MSB
#define MBOX_FIFO_STATUS_RX_EOM_LSB WLAN_MBOX_FIFO_STATUS_RX_EOM_LSB
#define MBOX_FIFO_STATUS_RX_EOM_MASK WLAN_MBOX_FIFO_STATUS_RX_EOM_MASK
#define MBOX_FIFO_STATUS_RX_EOM_GET(x) WLAN_MBOX_FIFO_STATUS_RX_EOM_GET(x)
#define MBOX_FIFO_STATUS_RX_EOM_SET(x) WLAN_MBOX_FIFO_STATUS_RX_EOM_SET(x)
...
#define MBOX_FIFO_STATUS_TX_EOM_MSB WLAN_MBOX_FIFO_STATUS_TX_EOM_MSB
#define MBOX_FIFO_STATUS_TX_EOM_LSB WLAN_MBOX_FIFO_STATUS_TX_EOM_LSB
#define MBOX_FIFO_STATUS_TX_EOM_MASK WLAN_MBOX_FIFO_STATUS_TX_EOM_MASK
#define MBOX_FIFO_STATUS_TX_EOM_GET(x) WLAN_MBOX_FIFO_STATUS_TX_EOM_GET(x)
#define MBOX_FIFO_STATUS_TX_EOM_SET(x) WLAN_MBOX_FIFO_STATUS_TX_EOM_SET(x)
#define MBOX_FIFO_STATUS_BYTE_VALID_MAP_MSB WLAN_MBOX_FIFO_STATUS_BYTE_VALID_MAP_MSB
#define MBOX_FIFO_STATUS_BYTE_VALID_MAP_LSB WLAN_MBOX_FIFO_STATUS_BYTE_VALID_MAP_LSB
#define MBOX_FIFO_STATUS_BYTE_VALID_MAP_MASK WLAN_MBOX_FIFO_STATUS_BYTE_VALID_MAP_MASK
#define MBOX_FIFO_STATUS_BYTE_VALID_MAP_GET(x) WLAN_MBOX_FIFO_STATUS_BYTE_VALID_MAP_GET(x)
#define MBOX_FIFO_STATUS_BYTE_VALID_MAP_SET(x) WLAN_MBOX_FIFO_STATUS_BYTE_VALID_MAP_SET(x)
...
#define MBOX0_DMA_RX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX0_DMA_RX_CONTROL_DESC_IN_USE_MSB
#define MBOX0_DMA_RX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX0_DMA_RX_CONTROL_DESC_IN_USE_LSB
#define MBOX0_DMA_RX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX0_DMA_RX_CONTROL_DESC_IN_USE_MASK
#define MBOX0_DMA_RX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX0_DMA_RX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX0_DMA_RX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX0_DMA_RX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX0_DMA_TX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX0_DMA_TX_CONTROL_DESC_IN_USE_MSB
#define MBOX0_DMA_TX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX0_DMA_TX_CONTROL_DESC_IN_USE_LSB
#define MBOX0_DMA_TX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX0_DMA_TX_CONTROL_DESC_IN_USE_MASK
#define MBOX0_DMA_TX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX0_DMA_TX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX0_DMA_TX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX0_DMA_TX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX1_DMA_RX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX1_DMA_RX_CONTROL_DESC_IN_USE_MSB
#define MBOX1_DMA_RX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX1_DMA_RX_CONTROL_DESC_IN_USE_LSB
#define MBOX1_DMA_RX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX1_DMA_RX_CONTROL_DESC_IN_USE_MASK
#define MBOX1_DMA_RX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX1_DMA_RX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX1_DMA_RX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX1_DMA_RX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX1_DMA_TX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX1_DMA_TX_CONTROL_DESC_IN_USE_MSB
#define MBOX1_DMA_TX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX1_DMA_TX_CONTROL_DESC_IN_USE_LSB
#define MBOX1_DMA_TX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX1_DMA_TX_CONTROL_DESC_IN_USE_MASK
#define MBOX1_DMA_TX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX1_DMA_TX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX1_DMA_TX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX1_DMA_TX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX2_DMA_RX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX2_DMA_RX_CONTROL_DESC_IN_USE_MSB
#define MBOX2_DMA_RX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX2_DMA_RX_CONTROL_DESC_IN_USE_LSB
#define MBOX2_DMA_RX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX2_DMA_RX_CONTROL_DESC_IN_USE_MASK
#define MBOX2_DMA_RX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX2_DMA_RX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX2_DMA_RX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX2_DMA_RX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX2_DMA_TX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX2_DMA_TX_CONTROL_DESC_IN_USE_MSB
#define MBOX2_DMA_TX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX2_DMA_TX_CONTROL_DESC_IN_USE_LSB
#define MBOX2_DMA_TX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX2_DMA_TX_CONTROL_DESC_IN_USE_MASK
#define MBOX2_DMA_TX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX2_DMA_TX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX2_DMA_TX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX2_DMA_TX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX3_DMA_RX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX3_DMA_RX_CONTROL_DESC_IN_USE_MSB
#define MBOX3_DMA_RX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX3_DMA_RX_CONTROL_DESC_IN_USE_LSB
#define MBOX3_DMA_RX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX3_DMA_RX_CONTROL_DESC_IN_USE_MASK
#define MBOX3_DMA_RX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX3_DMA_RX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX3_DMA_RX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX3_DMA_RX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX3_DMA_TX_CONTROL_DESC_IN_USE_MSB WLAN_MBOX3_DMA_TX_CONTROL_DESC_IN_USE_MSB
#define MBOX3_DMA_TX_CONTROL_DESC_IN_USE_LSB WLAN_MBOX3_DMA_TX_CONTROL_DESC_IN_USE_LSB
#define MBOX3_DMA_TX_CONTROL_DESC_IN_USE_MASK WLAN_MBOX3_DMA_TX_CONTROL_DESC_IN_USE_MASK
#define MBOX3_DMA_TX_CONTROL_DESC_IN_USE_GET(x) WLAN_MBOX3_DMA_TX_CONTROL_DESC_IN_USE_GET(x)
#define MBOX3_DMA_TX_CONTROL_DESC_IN_USE_SET(x) WLAN_MBOX3_DMA_TX_CONTROL_DESC_IN_USE_SET(x)
...
#define MBOX_FIFO_MODE_CONTROL_ADDRESS WLAN_MBOX_FIFO_MODE_CONTROL_ADDRESS
#define MBOX_FIFO_MODE_CONTROL_OFFSET WLAN_MBOX_FIFO_MODE_CONTROL_OFFSET
#define MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_MSB WLAN_MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_MSB
#define MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_LSB WLAN_MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_LSB
#define MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_MASK WLAN_MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_MASK
#define MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_GET(x) WLAN_MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_GET(x)
#define MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_SET(x) WLAN_MBOX_FIFO_MODE_CONTROL_MULTI_CHAN_ENABLE_SET(x)
#define MBOX_TX_DMA_RESIDUAL_PACK_ADDRESS WLAN_MBOX_TX_DMA_RESIDUAL_PACK_ADDRESS
#define MBOX_TX_DMA_RESIDUAL_PACK_OFFSET WLAN_MBOX_TX_DMA_RESIDUAL_PACK_OFFSET
#define MBOX_TX_DMA_RESIDUAL_PACK_EN_MSB WLAN_MBOX_TX_DMA_RESIDUAL_PACK_EN_MSB
#define MBOX_TX_DMA_RESIDUAL_PACK_EN_LSB WLAN_MBOX_TX_DMA_RESIDUAL_PACK_EN_LSB
#define MBOX_TX_DMA_RESIDUAL_PACK_EN_MASK WLAN_MBOX_TX_DMA_RESIDUAL_PACK_EN_MASK
#define MBOX_TX_DMA_RESIDUAL_PACK_EN_GET(x) WLAN_MBOX_TX_DMA_RESIDUAL_PACK_EN_GET(x)
#define MBOX_TX_DMA_RESIDUAL_PACK_EN_SET(x) WLAN_MBOX_TX_DMA_RESIDUAL_PACK_EN_SET(x)
#define MBOX_NUM_AXI_OUTSTANDING_ADDRESS WLAN_MBOX_NUM_AXI_OUTSTANDING_ADDRESS
#define MBOX_NUM_AXI_OUTSTANDING_OFFSET WLAN_MBOX_NUM_AXI_OUTSTANDING_OFFSET
#define MBOX_NUM_AXI_OUTSTANDING_READS_MSB WLAN_MBOX_NUM_AXI_OUTSTANDING_READS_MSB
#define MBOX_NUM_AXI_OUTSTANDING_READS_LSB WLAN_MBOX_NUM_AXI_OUTSTANDING_READS_LSB
#define MBOX_NUM_AXI_OUTSTANDING_READS_MASK WLAN_MBOX_NUM_AXI_OUTSTANDING_READS_MASK
#define MBOX_NUM_AXI_OUTSTANDING_READS_GET(x) WLAN_MBOX_NUM_AXI_OUTSTANDING_READS_GET(x)
#define MBOX_NUM_AXI_OUTSTANDING_READS_SET(x) WLAN_MBOX_NUM_AXI_OUTSTANDING_READS_SET(x)
#define MBOX_NUM_AXI_OUTSTANDING_WRITES_MSB WLAN_MBOX_NUM_AXI_OUTSTANDING_WRITES_MSB
#define MBOX_NUM_AXI_OUTSTANDING_WRITES_LSB WLAN_MBOX_NUM_AXI_OUTSTANDING_WRITES_LSB
#define MBOX_NUM_AXI_OUTSTANDING_WRITES_MASK WLAN_MBOX_NUM_AXI_OUTSTANDING_WRITES_MASK
#define MBOX_NUM_AXI_OUTSTANDING_WRITES_GET(x) WLAN_MBOX_NUM_AXI_OUTSTANDING_WRITES_GET(x)
#define MBOX_NUM_AXI_OUTSTANDING_WRITES_SET(x) WLAN_MBOX_NUM_AXI_OUTSTANDING_WRITES_SET(x)
#define MBOX_DMA_MAX_BEAT_ADDRESS WLAN_MBOX_DMA_MAX_BEAT_ADDRESS
#define MBOX_DMA_MAX_BEAT_OFFSET WLAN_MBOX_DMA_MAX_BEAT_OFFSET
#define MBOX_DMA_MAX_BEAT_RX_SEL_MSB WLAN_MBOX_DMA_MAX_BEAT_RX_SEL_MSB
#define MBOX_DMA_MAX_BEAT_RX_SEL_LSB WLAN_MBOX_DMA_MAX_BEAT_RX_SEL_LSB
#define MBOX_DMA_MAX_BEAT_RX_SEL_MASK WLAN_MBOX_DMA_MAX_BEAT_RX_SEL_MASK
#define MBOX_DMA_MAX_BEAT_RX_SEL_GET(x) WLAN_MBOX_DMA_MAX_BEAT_RX_SEL_GET(x)
#define MBOX_DMA_MAX_BEAT_RX_SEL_SET(x) WLAN_MBOX_DMA_MAX_BEAT_RX_SEL_SET(x)
#define MBOX_DMA_MAX_BEAT_SPACE_MASK_MSB WLAN_MBOX_DMA_MAX_BEAT_SPACE_MASK_MSB
#define MBOX_DMA_MAX_BEAT_SPACE_MASK_LSB WLAN_MBOX_DMA_MAX_BEAT_SPACE_MASK_LSB
#define MBOX_DMA_MAX_BEAT_SPACE_MASK_MASK WLAN_MBOX_DMA_MAX_BEAT_SPACE_MASK_MASK
#define MBOX_DMA_MAX_BEAT_SPACE_MASK_GET(x) WLAN_MBOX_DMA_MAX_BEAT_SPACE_MASK_GET(x)
#define MBOX_DMA_MAX_BEAT_SPACE_MASK_SET(x) WLAN_MBOX_DMA_MAX_BEAT_SPACE_MASK_SET(x)
