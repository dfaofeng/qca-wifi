...
//	55	tpc_init_pwr_cfg[2:0], dpd_en[3], measure_power[4], clpc_en[5], fake_mumimo_user_num[7:6], fake_mumimo_nsts_users[19:8], fake_mumimo_ndp[20], tpc_sign_bit[21], fake_mumimo_coding[25:22], fake_mumimo_mcs[29:26], fake_mumimo_txbf[30], reserved_55a[31]
//
// ################ END SUMMARY #################

#define NUM_OF_DWORDS_TX_PPDU_START 56
...
struct tx_ppdu_start {
    ...
    volatile uint32_t tpc_init_pwr_cfg                :  3, //[2:0]
                      ...
                      measure_power                   :  1, //[4]
                      clpc_en                         :  1, //[5]
                      fake_mumimo_user_num            :  2, //[7:6]
                      fake_mumimo_nsts_users          : 12, //[19:8]
                      fake_mumimo_ndp                 :  1, //[20]
                      tpc_sign_bit                    :  1, //[21]
                      fake_mumimo_coding              :  4, //[25:22]
                      fake_mumimo_mcs                 :  4, //[29:26]
                      fake_mumimo_txbf                :  1, //[30]
                      reserved_55a                    :  1; //[31]
};
...
tpc_init_pwr_cfg
			Initial analog gain and PA configuration setting 
			·         0-4: 0 being the highest power consumption and
				best EVM and 4 being the lowest power consumption and worst
				EVM 
			5-7: reserved

dpd_en
			0:DPD profile not applied to current packet
			1:DPD profile applied to current packet

measure_power
			This field will trigger TPC to launch measured power into
			register
			·         TPC will not latch power measurement result for
				current packet 
			·         TPC will latch power measurement result for
				current packet 
			

clpc_en
			0: Disable TPC_error update, use gain lut entry as is, Other
			than clip_comp_factor adjustment if heavy_clip is enabled
			1: TPC error will be applied to DAC gain setting for the
				next packet

fake_mumimo_user_num
			0: user 1
			1: user 2
			2: user 3
			3: user 4

fake_mumimo_nsts_users
			10:8 – User 0 Nsts for fake MU-MIMO support 
			13:11- User 1 Nsts for fake MU-MIMO support 
			16:14- User 2 Nsts for fake MU-MIMO support 
			19:17- User 3 Nsts for fake MU-MIMO support  
			

fake_mumimo_ndp
			Generate NDP for fake MU-MIMO transmission 

tpc_sign_bit
			Sign bit for TPC 

fake_mumimo_coding
			Provides the coding info in MU if Nsts is not Zero;
			Bit#25 is reserved and should be always programmed to be a 1
				in SW. 

fake_mumimo_mcs
			Provides the MCS info for MU in VHT-SIGB

fake_mumimo_txbf
			Transmit beamformed packet for fake MU Tx
...
/* Description		TX_PPDU_START_55_TPC_INIT_PWR_CFG
			Initial analog gain and PA configuration setting 
			·         0-4: 0 being the highest power consumption and
				best EVM and 4 being the lowest power consumption and worst
				EVM 
			5-7: reserved
*/
#define TX_PPDU_START_55_TPC_INIT_PWR_CFG_OFFSET                     0x000000dc
#define TX_PPDU_START_55_TPC_INIT_PWR_CFG_LSB                        0
#define TX_PPDU_START_55_TPC_INIT_PWR_CFG_MASK                       0x00000007

/* Description		TX_PPDU_START_55_DPD_EN
			0:DPD profile not applied to current packet
			1:DPD profile applied to current packet
*/
#define TX_PPDU_START_55_DPD_EN_OFFSET                               0x000000dc
#define TX_PPDU_START_55_DPD_EN_LSB                                  3
#define TX_PPDU_START_55_DPD_EN_MASK                                 0x00000008

/* Description		TX_PPDU_START_55_MEASURE_POWER
			This field will trigger TPC to launch measured power into
			register
			·         TPC will not latch power measurement result for
				current packet 
...
*/
#define TX_PPDU_START_55_MEASURE_POWER_OFFSET                        0x000000dc
#define TX_PPDU_START_55_MEASURE_POWER_LSB                           4
#define TX_PPDU_START_55_MEASURE_POWER_MASK                          0x00000010

/* Description		TX_PPDU_START_55_CLPC_EN
			0: Disable TPC_error update, use gain lut entry as is, Other
			than clip_comp_factor adjustment if heavy_clip is enabled
			1: TPC error will be applied to DAC gain setting for the
				next packet
*/
#define TX_PPDU_START_55_CLPC_EN_OFFSET                              0x000000dc
#define TX_PPDU_START_55_CLPC_EN_LSB                                 5
#define TX_PPDU_START_55_CLPC_EN_MASK                                0x00000020

/* Description		TX_PPDU_START_55_FAKE_MUMIMO_USER_NUM
			0: user 1
			1: user 2
			2: user 3
			3: user 4
*/
#define TX_PPDU_START_55_FAKE_MUMIMO_USER_NUM_OFFSET                 0x000000dc
#define TX_PPDU_START_55_FAKE_MUMIMO_USER_NUM_LSB                    6
#define TX_PPDU_START_55_FAKE_MUMIMO_USER_NUM_MASK                   0x000000c0

/* Description		TX_PPDU_START_55_FAKE_MUMIMO_NSTS_USERS
			10:8 – User 0 Nsts for fake MU-MIMO support 
			13:11- User 1 Nsts for fake MU-MIMO support 
			16:14- User 2 Nsts for fake MU-MIMO support 
			19:17- User 3 Nsts for fake MU-MIMO support  
...
*/
#define TX_PPDU_START_55_FAKE_MUMIMO_NSTS_USERS_OFFSET               0x000000dc
#define TX_PPDU_START_55_FAKE_MUMIMO_NSTS_USERS_LSB                  8
#define TX_PPDU_START_55_FAKE_MUMIMO_NSTS_USERS_MASK                 0x000fff00

/* Description		TX_PPDU_START_55_FAKE_MUMIMO_NDP
			Generate NDP for fake MU-MIMO transmission 
*/
#define TX_PPDU_START_55_FAKE_MUMIMO_NDP_OFFSET                      0x000000dc
#define TX_PPDU_START_55_FAKE_MUMIMO_NDP_LSB                         20
#define TX_PPDU_START_55_FAKE_MUMIMO_NDP_MASK                        0x00100000

/* Description		TX_PPDU_START_55_TPC_SIGN_BIT
			Sign bit for TPC 
*/
#define TX_PPDU_START_55_TPC_SIGN_BIT_OFFSET                         0x000000dc
#define TX_PPDU_START_55_TPC_SIGN_BIT_LSB                            21
#define TX_PPDU_START_55_TPC_SIGN_BIT_MASK                           0x00200000

/* Description		TX_PPDU_START_55_FAKE_MUMIMO_CODING
			Provides the coding info in MU if Nsts is not Zero;
			Bit#25 is reserved and should be always programmed to be a 1
				in SW. 
*/
#define TX_PPDU_START_55_FAKE_MUMIMO_CODING_OFFSET                   0x000000dc
#define TX_PPDU_START_55_FAKE_MUMIMO_CODING_LSB                      22
#define TX_PPDU_START_55_FAKE_MUMIMO_CODING_MASK                     0x03c00000

/* Description		TX_PPDU_START_55_FAKE_MUMIMO_MCS
			Provides the MCS info for MU in VHT-SIGB
*/
#define TX_PPDU_START_55_FAKE_MUMIMO_MCS_OFFSET                      0x000000dc
#define TX_PPDU_START_55_FAKE_MUMIMO_MCS_LSB                         26
#define TX_PPDU_START_55_FAKE_MUMIMO_MCS_MASK                        0x3c000000

/* Description		TX_PPDU_START_55_FAKE_MUMIMO_TXBF
			Transmit beamformed packet for fake MU Tx
*/
#define TX_PPDU_START_55_FAKE_MUMIMO_TXBF_OFFSET                     0x000000dc
#define TX_PPDU_START_55_FAKE_MUMIMO_TXBF_LSB                        30
#define TX_PPDU_START_55_FAKE_MUMIMO_TXBF_MASK                       0x40000000

/* Description		TX_PPDU_START_55_RESERVED_55A
			Reserved.  Not used by HW.
			<legal:0>
*/
#define TX_PPDU_START_55_RESERVED_55A_OFFSET                         0x000000dc
#define TX_PPDU_START_55_RESERVED_55A_LSB                            31
#define TX_PPDU_START_55_RESERVED_55A_MASK                           0x80000000
