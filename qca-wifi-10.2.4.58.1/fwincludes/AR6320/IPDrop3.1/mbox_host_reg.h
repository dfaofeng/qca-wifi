...
// Creator:    tyzhang                                                         
// Time:       Monday Sep 24, 2012 [8:14:50 pm]                                
//                                                                             
...
//                                                                             
// Sources:    /trees/mbu-cn1/tyzhang/tianfang_enc_depot/chips/rome/dev/doc/rtl/wlan/mbox_wlan/blueprint/mbox_host_reg.rdl
...
// 0x0860 (SDIO_SCRATCH_0)
#define SDIO_SCRATCH_0_VALUE_MSB                                     31
#define SDIO_SCRATCH_0_VALUE_LSB                                     0
#define SDIO_SCRATCH_0_VALUE_MASK                                    0xffffffff
#define SDIO_SCRATCH_0_VALUE_GET(x)                                  (((x) & SDIO_SCRATCH_0_VALUE_MASK) >> SDIO_SCRATCH_0_VALUE_LSB)
#define SDIO_SCRATCH_0_VALUE_SET(x)                                  (((0 | (x)) << SDIO_SCRATCH_0_VALUE_LSB) & SDIO_SCRATCH_0_VALUE_MASK)
#define SDIO_SCRATCH_0_VALUE_RESET                                   0
#define SDIO_SCRATCH_0_ADDRESS                                       0x0860
#define SDIO_SCRATCH_ADDRESS                                         SDIO_SCRATCH_0_ADDRESS
#define SDIO_SCRATCH_0_HW_MASK                                       0xffffffff
#define SDIO_SCRATCH_0_SW_MASK                                       0xffffffff
#define SDIO_SCRATCH_0_HW_WRITE_MASK                                 0xffffffff
#define SDIO_SCRATCH_0_SW_WRITE_MASK                                 0xffffffff
#define SDIO_SCRATCH_0_RSTMASK                                       0xffffffff
#define SDIO_SCRATCH_0_RESET                                         0x00000000

// 0x0864 (SDIO_SCRATCH_1)
#define SDIO_SCRATCH_1_VALUE_MSB                                     31
#define SDIO_SCRATCH_1_VALUE_LSB                                     0
#define SDIO_SCRATCH_1_VALUE_MASK                                    0xffffffff
#define SDIO_SCRATCH_1_VALUE_GET(x)                                  (((x) & SDIO_SCRATCH_1_VALUE_MASK) >> SDIO_SCRATCH_1_VALUE_LSB)
#define SDIO_SCRATCH_1_VALUE_SET(x)                                  (((0 | (x)) << SDIO_SCRATCH_1_VALUE_LSB) & SDIO_SCRATCH_1_VALUE_MASK)
#define SDIO_SCRATCH_1_VALUE_RESET                                   0
#define SDIO_SCRATCH_1_ADDRESS                                       0x0864
#define SDIO_SCRATCH_1_HW_MASK                                       0xffffffff
#define SDIO_SCRATCH_1_SW_MASK                                       0xffffffff
#define SDIO_SCRATCH_1_HW_WRITE_MASK                                 0xffffffff
#define SDIO_SCRATCH_1_SW_WRITE_MASK                                 0xffffffff
#define SDIO_SCRATCH_1_RSTMASK                                       0xffffffff
#define SDIO_SCRATCH_1_RESET                                         0x00000000
