...
#define WLAN_CPU_IROM_BASE  0x928000
#define WLAN_CPU_IROM_BLOCK_32KB_SIZE (32*KBYTE)
#define WLAN_CPU_IROM_BLOCK_32KB_NUM 1
#define WLAN_CPU_IROM_BLOCK_64KB_SIZE (64*KBYTE) /*tricky, in fact it includes two 32K*/
#define WLAN_CPU_IROM_BLOCK_64KB_NUM 5
#define WLAN_CPU_IROM_BLOCK_NUM (WLAN_CPU_IROM_BLOCK_64KB_NUM+WLAN_CPU_IROM_BLOCK_32KB_NUM) 
#define WLAN_CPU_IROM_SIZE  (WLAN_CPU_IROM_BLOCK_32KB_SIZE*WLAN_CPU_IROM_BLOCK_32KB_NUM + WLAN_CPU_IROM_BLOCK_64KB_SIZE*WLAN_CPU_IROM_BLOCK_64KB_NUM)
#define WLAN_CPU_ROM_SIZE  (352*KBYTE)
...
#define BT_CPU_IROM_BLOCK_NUM 9
...
/*dummy address*/
#define SOC_DUMMY_ADDRESS 0x0003AFF8
