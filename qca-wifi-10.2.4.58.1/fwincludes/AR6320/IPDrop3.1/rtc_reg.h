...
#define MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MSB WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MSB
#define MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_LSB WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_LSB
#define MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MASK WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MASK
#define MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_GET(x) WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_GET(x)
#define MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_SET(x) WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_SET(x)
#define MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_RESET WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_RESET
...
#define RESET_CONTROL_PCIE_RST_SHORT_OVRD_MSB SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_MSB
#define RESET_CONTROL_PCIE_RST_SHORT_OVRD_LSB SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_LSB
#define RESET_CONTROL_PCIE_RST_SHORT_OVRD_MASK SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_MASK
#define RESET_CONTROL_PCIE_RST_SHORT_OVRD_GET(x) SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_GET(x)
#define RESET_CONTROL_PCIE_RST_SHORT_OVRD_SET(x) SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_SET(x)
#define RESET_CONTROL_INTF_MEM_1_RST_MSB SOC_RESET_CONTROL_INTF_MEM_1_RST_MSB
#define RESET_CONTROL_INTF_MEM_1_RST_LSB SOC_RESET_CONTROL_INTF_MEM_1_RST_LSB
#define RESET_CONTROL_INTF_MEM_1_RST_MASK SOC_RESET_CONTROL_INTF_MEM_1_RST_MASK
#define RESET_CONTROL_INTF_MEM_1_RST_GET(x) SOC_RESET_CONTROL_INTF_MEM_1_RST_GET(x)
#define RESET_CONTROL_INTF_MEM_1_RST_SET(x) SOC_RESET_CONTROL_INTF_MEM_1_RST_SET(x)
#define RESET_CONTROL_INTF_MEM_0_RST_MSB SOC_RESET_CONTROL_INTF_MEM_0_RST_MSB
#define RESET_CONTROL_INTF_MEM_0_RST_LSB SOC_RESET_CONTROL_INTF_MEM_0_RST_LSB
#define RESET_CONTROL_INTF_MEM_0_RST_MASK SOC_RESET_CONTROL_INTF_MEM_0_RST_MASK
#define RESET_CONTROL_INTF_MEM_0_RST_GET(x) SOC_RESET_CONTROL_INTF_MEM_0_RST_GET(x)
#define RESET_CONTROL_INTF_MEM_0_RST_SET(x) SOC_RESET_CONTROL_INTF_MEM_0_RST_SET(x)
...
#define RESET_CONTROL_AXI2AHB_RST_MSB SOC_RESET_CONTROL_AXI2AHB_RST_MSB
#define RESET_CONTROL_AXI2AHB_RST_LSB SOC_RESET_CONTROL_AXI2AHB_RST_LSB
#define RESET_CONTROL_AXI2AHB_RST_MASK SOC_RESET_CONTROL_AXI2AHB_RST_MASK
#define RESET_CONTROL_AXI2AHB_RST_GET(x) SOC_RESET_CONTROL_AXI2AHB_RST_GET(x)
#define RESET_CONTROL_AXI2AHB_RST_SET(x) SOC_RESET_CONTROL_AXI2AHB_RST_SET(x)
...
#define INT_STATUS_RTC_SLEEPING_MSB SOC_INT_STATUS_RTC_SLEEPING_MSB
#define INT_STATUS_RTC_SLEEPING_LSB SOC_INT_STATUS_RTC_SLEEPING_LSB
#define INT_STATUS_RTC_SLEEPING_MASK SOC_INT_STATUS_RTC_SLEEPING_MASK
#define INT_STATUS_RTC_SLEEPING_GET(x) SOC_INT_STATUS_RTC_SLEEPING_GET(x)
#define INT_STATUS_RTC_SLEEPING_SET(x) SOC_INT_STATUS_RTC_SLEEPING_SET(x)
...
#define CHIP_ID_VERSION_MSB SOC_CHIP_ID_VERSION_MSB
#define CHIP_ID_VERSION_LSB SOC_CHIP_ID_VERSION_LSB
#define CHIP_ID_VERSION_MASK SOC_CHIP_ID_VERSION_MASK
#define CHIP_ID_VERSION_GET(x) SOC_CHIP_ID_VERSION_GET(x)
#define CHIP_ID_VERSION_SET(x) SOC_CHIP_ID_VERSION_SET(x)
#define CHIP_ID_TYPE_MSB SOC_CHIP_ID_TYPE_MSB
#define CHIP_ID_TYPE_LSB SOC_CHIP_ID_TYPE_LSB
#define CHIP_ID_TYPE_MASK SOC_CHIP_ID_TYPE_MASK
#define CHIP_ID_TYPE_GET(x) SOC_CHIP_ID_TYPE_GET(x)
#define CHIP_ID_TYPE_SET(x) SOC_CHIP_ID_TYPE_SET(x)
#define CHIP_ID_REVISION_MSB SOC_CHIP_ID_REVISION_MSB
#define CHIP_ID_REVISION_LSB SOC_CHIP_ID_REVISION_LSB
#define CHIP_ID_REVISION_MASK SOC_CHIP_ID_REVISION_MASK
#define CHIP_ID_REVISION_GET(x) SOC_CHIP_ID_REVISION_GET(x)
#define CHIP_ID_REVISION_SET(x) SOC_CHIP_ID_REVISION_SET(x)
#define CHIP_ID_OLD_VERSION_MSB SOC_CHIP_ID_OLD_VERSION_MSB
#define CHIP_ID_OLD_VERSION_LSB SOC_CHIP_ID_OLD_VERSION_LSB
#define CHIP_ID_OLD_VERSION_MASK SOC_CHIP_ID_OLD_VERSION_MASK
#define CHIP_ID_OLD_VERSION_GET(x) SOC_CHIP_ID_OLD_VERSION_GET(x)
#define CHIP_ID_OLD_VERSION_SET(x) SOC_CHIP_ID_OLD_VERSION_SET(x)
#define POWER_REG_ADDRESS SOC_POWER_REG_ADDRESS
#define POWER_REG_OFFSET SOC_POWER_REG_OFFSET
#define POWER_REG_SLP_REG33_ON_MSB SOC_POWER_REG_SLP_REG33_ON_MSB
#define POWER_REG_SLP_REG33_ON_LSB SOC_POWER_REG_SLP_REG33_ON_LSB
#define POWER_REG_SLP_REG33_ON_MASK SOC_POWER_REG_SLP_REG33_ON_MASK
#define POWER_REG_SLP_REG33_ON_GET(x) SOC_POWER_REG_SLP_REG33_ON_GET(x)
#define POWER_REG_SLP_REG33_ON_SET(x) SOC_POWER_REG_SLP_REG33_ON_SET(x)
...
#define AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MSB WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MSB
#define AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_LSB WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_LSB
#define AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MASK WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MASK
#define AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_GET(x) WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_GET(x)
#define AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_SET(x) WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_SET(x)
...
#define AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO24_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO24_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO24_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO23_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO23_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO23_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO22_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO22_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO22_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO21_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO21_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO21_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO20_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO20_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO20_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO19_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO19_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO19_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO18_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO18_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO18_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO16_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO16_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO16_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO15_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO15_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO15_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO14_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO14_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO14_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO13_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO13_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO13_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO11_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO11_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO11_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO10_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO10_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO10_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_SET(x)
#define AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MSB WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MSB
#define AO_GPIO_CONFIG_GPIO8_DEBUG_EN_LSB WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_LSB
#define AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MASK WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MASK
#define AO_GPIO_CONFIG_GPIO8_DEBUG_EN_GET(x) WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_GET(x)
#define AO_GPIO_CONFIG_GPIO8_DEBUG_EN_SET(x) WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_SET(x)
