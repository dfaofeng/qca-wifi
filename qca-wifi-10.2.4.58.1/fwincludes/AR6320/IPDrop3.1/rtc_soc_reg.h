...
#define SOC_RESET_CONTROL_HCI_UART_RST_MSB       17
#define SOC_RESET_CONTROL_HCI_UART_RST_LSB       17
#define SOC_RESET_CONTROL_HCI_UART_RST_MASK      0x00020000
#define SOC_RESET_CONTROL_HCI_UART_RST_GET(x)    (((x) & SOC_RESET_CONTROL_HCI_UART_RST_MASK) >> SOC_RESET_CONTROL_HCI_UART_RST_LSB)
#define SOC_RESET_CONTROL_HCI_UART_RST_SET(x)    (((x) << SOC_RESET_CONTROL_HCI_UART_RST_LSB) & SOC_RESET_CONTROL_HCI_UART_RST_MASK)
...
#define SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_MSB 5
#define SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_LSB 5
#define SOC_RESET_CONTROL_PCIE_RST_SHORT_OVRD_MASK 0x00000020
...
#define SOC_RESET_CONTROL_INTF_MEM_1_RST_MSB     4
#define SOC_RESET_CONTROL_INTF_MEM_1_RST_LSB     4
#define SOC_RESET_CONTROL_INTF_MEM_1_RST_MASK    0x00000010
#define SOC_RESET_CONTROL_INTF_MEM_1_RST_GET(x)  (((x) & SOC_RESET_CONTROL_INTF_MEM_1_RST_MASK) >> SOC_RESET_CONTROL_INTF_MEM_1_RST_LSB)
#define SOC_RESET_CONTROL_INTF_MEM_1_RST_SET(x)  (((x) << SOC_RESET_CONTROL_INTF_MEM_1_RST_LSB) & SOC_RESET_CONTROL_INTF_MEM_1_RST_MASK)
#define SOC_RESET_CONTROL_INTF_MEM_0_RST_MSB     3
#define SOC_RESET_CONTROL_INTF_MEM_0_RST_LSB     3
#define SOC_RESET_CONTROL_INTF_MEM_0_RST_MASK    0x00000008
#define SOC_RESET_CONTROL_INTF_MEM_0_RST_GET(x)  (((x) & SOC_RESET_CONTROL_INTF_MEM_0_RST_MASK) >> SOC_RESET_CONTROL_INTF_MEM_0_RST_LSB)
#define SOC_RESET_CONTROL_INTF_MEM_0_RST_SET(x)  (((x) << SOC_RESET_CONTROL_INTF_MEM_0_RST_LSB) & SOC_RESET_CONTROL_INTF_MEM_0_RST_MASK)
...
#define SOC_RESET_CONTROL_AXI2AHB_RST_MSB        1
#define SOC_RESET_CONTROL_AXI2AHB_RST_LSB        1
#define SOC_RESET_CONTROL_AXI2AHB_RST_MASK       0x00000002
#define SOC_RESET_CONTROL_AXI2AHB_RST_GET(x)     (((x) & SOC_RESET_CONTROL_AXI2AHB_RST_MASK) >> SOC_RESET_CONTROL_AXI2AHB_RST_LSB)
#define SOC_RESET_CONTROL_AXI2AHB_RST_SET(x)     (((x) << SOC_RESET_CONTROL_AXI2AHB_RST_LSB) & SOC_RESET_CONTROL_AXI2AHB_RST_MASK)
#define SOC_RESET_CONTROL_CE_RST_MSB             0
#define SOC_RESET_CONTROL_CE_RST_LSB             0
#define SOC_RESET_CONTROL_CE_RST_MASK            0x00000001
...
#define DIRAM_SHARE_CONTROL_ADDRESS              0x00000024
#define DIRAM_SHARE_CONTROL_OFFSET               0x00000024
#define DIRAM_SHARE_CONTROL_VALUE_MSB            2
#define DIRAM_SHARE_CONTROL_VALUE_LSB            0
#define DIRAM_SHARE_CONTROL_VALUE_MASK           0x00000007
#define DIRAM_SHARE_CONTROL_VALUE_GET(x)         (((x) & DIRAM_SHARE_CONTROL_VALUE_MASK) >> DIRAM_SHARE_CONTROL_VALUE_LSB)
#define DIRAM_SHARE_CONTROL_VALUE_SET(x)         (((x) << DIRAM_SHARE_CONTROL_VALUE_LSB) & DIRAM_SHARE_CONTROL_VALUE_MASK)

#define SOC_CLOCK_CONTROL_ADDRESS                0x00000028
#define SOC_CLOCK_CONTROL_OFFSET                 0x00000028
#define SOC_CLOCK_CONTROL_OBS_SEL_MSB            10
#define SOC_CLOCK_CONTROL_OBS_SEL_LSB            6
#define SOC_CLOCK_CONTROL_OBS_SEL_MASK           0x000007c0
#define SOC_CLOCK_CONTROL_OBS_SEL_GET(x)         (((x) & SOC_CLOCK_CONTROL_OBS_SEL_MASK) >> SOC_CLOCK_CONTROL_OBS_SEL_LSB)
#define SOC_CLOCK_CONTROL_OBS_SEL_SET(x)         (((x) << SOC_CLOCK_CONTROL_OBS_SEL_LSB) & SOC_CLOCK_CONTROL_OBS_SEL_MASK)
#define SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_MSB     5
#define SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_LSB     5
#define SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_MASK    0x00000020
#define SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_GET(x)  (((x) & SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_MASK) >> SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_LSB)
#define SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_SET(x)  (((x) << SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_LSB) & SOC_CLOCK_CONTROL_USB_AHB_CLK_EN_MASK)
#define SOC_CLOCK_CONTROL_HSIC_CLK_EN_MSB        4
#define SOC_CLOCK_CONTROL_HSIC_CLK_EN_LSB        4
#define SOC_CLOCK_CONTROL_HSIC_CLK_EN_MASK       0x00000010
#define SOC_CLOCK_CONTROL_HSIC_CLK_EN_GET(x)     (((x) & SOC_CLOCK_CONTROL_HSIC_CLK_EN_MASK) >> SOC_CLOCK_CONTROL_HSIC_CLK_EN_LSB)
#define SOC_CLOCK_CONTROL_HSIC_CLK_EN_SET(x)     (((x) << SOC_CLOCK_CONTROL_HSIC_CLK_EN_LSB) & SOC_CLOCK_CONTROL_HSIC_CLK_EN_MASK)
#define SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_MSB  3
#define SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_LSB  3
#define SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_MASK 0x00000008
#define SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_GET(x) (((x) & SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_MASK) >> SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_LSB)
#define SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_SET(x) (((x) << SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_LSB) & SOC_CLOCK_CONTROL_USB_SYSTEM_CLK_EN_MASK)
...
#define SOC_INT_STATUS_RTC_SLEEPING_MSB          28
#define SOC_INT_STATUS_RTC_SLEEPING_LSB          28
#define SOC_INT_STATUS_RTC_SLEEPING_MASK         0x10000000
#define SOC_INT_STATUS_RTC_SLEEPING_GET(x)       (((x) & SOC_INT_STATUS_RTC_SLEEPING_MASK) >> SOC_INT_STATUS_RTC_SLEEPING_LSB)
#define SOC_INT_STATUS_RTC_SLEEPING_SET(x)       (((x) << SOC_INT_STATUS_RTC_SLEEPING_LSB) & SOC_INT_STATUS_RTC_SLEEPING_MASK)
#define SOC_INT_STATUS_REMOTE_STATUS_F_INT_MSB   27
#define SOC_INT_STATUS_REMOTE_STATUS_F_INT_LSB   27
#define SOC_INT_STATUS_REMOTE_STATUS_F_INT_MASK  0x08000000
#define SOC_INT_STATUS_REMOTE_STATUS_F_INT_GET(x) (((x) & SOC_INT_STATUS_REMOTE_STATUS_F_INT_MASK) >> SOC_INT_STATUS_REMOTE_STATUS_F_INT_LSB)
#define SOC_INT_STATUS_REMOTE_STATUS_F_INT_SET(x) (((x) << SOC_INT_STATUS_REMOTE_STATUS_F_INT_LSB) & SOC_INT_STATUS_REMOTE_STATUS_F_INT_MASK)
#define SOC_INT_STATUS_REMOTE_STATUS_R_INT_MSB   26
#define SOC_INT_STATUS_REMOTE_STATUS_R_INT_LSB   26
#define SOC_INT_STATUS_REMOTE_STATUS_R_INT_MASK  0x04000000
#define SOC_INT_STATUS_REMOTE_STATUS_R_INT_GET(x) (((x) & SOC_INT_STATUS_REMOTE_STATUS_R_INT_MASK) >> SOC_INT_STATUS_REMOTE_STATUS_R_INT_LSB)
#define SOC_INT_STATUS_REMOTE_STATUS_R_INT_SET(x) (((x) << SOC_INT_STATUS_REMOTE_STATUS_R_INT_LSB) & SOC_INT_STATUS_REMOTE_STATUS_R_INT_MASK)
#define SOC_INT_STATUS_BT_REQ_WAKE_MSB           25
#define SOC_INT_STATUS_BT_REQ_WAKE_LSB           25
#define SOC_INT_STATUS_BT_REQ_WAKE_MASK          0x02000000
#define SOC_INT_STATUS_BT_REQ_WAKE_GET(x)        (((x) & SOC_INT_STATUS_BT_REQ_WAKE_MASK) >> SOC_INT_STATUS_BT_REQ_WAKE_LSB)
#define SOC_INT_STATUS_BT_REQ_WAKE_SET(x)        (((x) << SOC_INT_STATUS_BT_REQ_WAKE_LSB) & SOC_INT_STATUS_BT_REQ_WAKE_MASK)
#define SOC_INT_STATUS_USB_WAKEUP_MSB            24
#define SOC_INT_STATUS_USB_WAKEUP_LSB            24
#define SOC_INT_STATUS_USB_WAKEUP_MASK           0x01000000
#define SOC_INT_STATUS_USB_WAKEUP_GET(x)         (((x) & SOC_INT_STATUS_USB_WAKEUP_MASK) >> SOC_INT_STATUS_USB_WAKEUP_LSB)
#define SOC_INT_STATUS_USB_WAKEUP_SET(x)         (((x) << SOC_INT_STATUS_USB_WAKEUP_LSB) & SOC_INT_STATUS_USB_WAKEUP_MASK)
...
#define SOC_INT_STATUS_HCI_UART_MSB              15
#define SOC_INT_STATUS_HCI_UART_LSB              15
#define SOC_INT_STATUS_HCI_UART_MASK             0x00008000
...
#define SOC_RESET_CAUSE_ADDRESS                  0x000000bc
#define SOC_RESET_CAUSE_OFFSET                   0x000000bc
...
#define SOC_SYSTEM_SLEEP_ADDRESS                 0x000000c0
#define SOC_SYSTEM_SLEEP_OFFSET                  0x000000c0
...
#define SOC_SDIO_WRAPPER_ADDRESS                 0x000000c4
#define SOC_SDIO_WRAPPER_OFFSET                  0x000000c4
...
#define PCIE_L1SS_SLEEP_CONTROL_ADDRESS          0x000000c8
#define PCIE_L1SS_SLEEP_CONTROL_OFFSET           0x000000c8
#define PCIE_L1SS_SLEEP_CONTROL_ENABLE_MSB       0
#define PCIE_L1SS_SLEEP_CONTROL_ENABLE_LSB       0
#define PCIE_L1SS_SLEEP_CONTROL_ENABLE_MASK      0x00000001
#define PCIE_L1SS_SLEEP_CONTROL_ENABLE_GET(x)    (((x) & PCIE_L1SS_SLEEP_CONTROL_ENABLE_MASK) >> PCIE_L1SS_SLEEP_CONTROL_ENABLE_LSB)
#define PCIE_L1SS_SLEEP_CONTROL_ENABLE_SET(x)    (((x) << PCIE_L1SS_SLEEP_CONTROL_ENABLE_LSB) & PCIE_L1SS_SLEEP_CONTROL_ENABLE_MASK)
...
#define SOC_POWER_REG_SLP_REG33_ON_MSB           18
#define SOC_POWER_REG_SLP_REG33_ON_LSB           18
#define SOC_POWER_REG_SLP_REG33_ON_MASK          0x00040000
#define SOC_POWER_REG_SLP_REG33_ON_GET(x)        (((x) & SOC_POWER_REG_SLP_REG33_ON_MASK) >> SOC_POWER_REG_SLP_REG33_ON_LSB)
#define SOC_POWER_REG_SLP_REG33_ON_SET(x)        (((x) << SOC_POWER_REG_SLP_REG33_ON_LSB) & SOC_POWER_REG_SLP_REG33_ON_MASK)
#define SOC_POWER_REG_SLP_SWREG_ON_MSB           17
#define SOC_POWER_REG_SLP_SWREG_ON_LSB           17
#define SOC_POWER_REG_SLP_SWREG_ON_MASK          0x00020000
#define SOC_POWER_REG_SLP_SWREG_ON_GET(x)        (((x) & SOC_POWER_REG_SLP_SWREG_ON_MASK) >> SOC_POWER_REG_SLP_SWREG_ON_LSB)
#define SOC_POWER_REG_SLP_SWREG_ON_SET(x)        (((x) << SOC_POWER_REG_SLP_SWREG_ON_LSB) & SOC_POWER_REG_SLP_SWREG_ON_MASK)
#define SOC_POWER_REG_HYST_EN_MSB                16
#define SOC_POWER_REG_HYST_EN_LSB                16
#define SOC_POWER_REG_HYST_EN_MASK               0x00010000
#define SOC_POWER_REG_HYST_EN_GET(x)             (((x) & SOC_POWER_REG_HYST_EN_MASK) >> SOC_POWER_REG_HYST_EN_LSB)
#define SOC_POWER_REG_HYST_EN_SET(x)             (((x) << SOC_POWER_REG_HYST_EN_LSB) & SOC_POWER_REG_HYST_EN_MASK)
...
#define SLEEP_RETENTION_BB_CLK_EN_MSB            16
#define SLEEP_RETENTION_BB_CLK_EN_LSB            16
#define SLEEP_RETENTION_BB_CLK_EN_MASK           0x00010000
#define SLEEP_RETENTION_BB_CLK_EN_GET(x)         (((x) & SLEEP_RETENTION_BB_CLK_EN_MASK) >> SLEEP_RETENTION_BB_CLK_EN_LSB)
#define SLEEP_RETENTION_BB_CLK_EN_SET(x)         (((x) << SLEEP_RETENTION_BB_CLK_EN_LSB) & SLEEP_RETENTION_BB_CLK_EN_MASK)
#define SLEEP_RETENTION_SW_RESTORE_DONE_MSB      15
#define SLEEP_RETENTION_SW_RESTORE_DONE_LSB      15
#define SLEEP_RETENTION_SW_RESTORE_DONE_MASK     0x00008000
#define SLEEP_RETENTION_SW_RESTORE_DONE_GET(x)   (((x) & SLEEP_RETENTION_SW_RESTORE_DONE_MASK) >> SLEEP_RETENTION_SW_RESTORE_DONE_LSB)
#define SLEEP_RETENTION_SW_RESTORE_DONE_SET(x)   (((x) << SLEEP_RETENTION_SW_RESTORE_DONE_LSB) & SLEEP_RETENTION_SW_RESTORE_DONE_MASK)
#define SLEEP_RETENTION_SW_RESTORE_EN_MSB        14
#define SLEEP_RETENTION_SW_RESTORE_EN_LSB        14
#define SLEEP_RETENTION_SW_RESTORE_EN_MASK       0x00004000
#define SLEEP_RETENTION_SW_RESTORE_EN_GET(x)     (((x) & SLEEP_RETENTION_SW_RESTORE_EN_MASK) >> SLEEP_RETENTION_SW_RESTORE_EN_LSB)
#define SLEEP_RETENTION_SW_RESTORE_EN_SET(x)     (((x) << SLEEP_RETENTION_SW_RESTORE_EN_LSB) & SLEEP_RETENTION_SW_RESTORE_EN_MASK)
#define SLEEP_RETENTION_SW_SAVE_DONE_MSB         13
#define SLEEP_RETENTION_SW_SAVE_DONE_LSB         13
#define SLEEP_RETENTION_SW_SAVE_DONE_MASK        0x00002000
#define SLEEP_RETENTION_SW_SAVE_DONE_GET(x)      (((x) & SLEEP_RETENTION_SW_SAVE_DONE_MASK) >> SLEEP_RETENTION_SW_SAVE_DONE_LSB)
#define SLEEP_RETENTION_SW_SAVE_DONE_SET(x)      (((x) << SLEEP_RETENTION_SW_SAVE_DONE_LSB) & SLEEP_RETENTION_SW_SAVE_DONE_MASK)
#define SLEEP_RETENTION_SW_SAVE_EN_MSB           12
#define SLEEP_RETENTION_SW_SAVE_EN_LSB           12
#define SLEEP_RETENTION_SW_SAVE_EN_MASK          0x00001000
#define SLEEP_RETENTION_SW_SAVE_EN_GET(x)        (((x) & SLEEP_RETENTION_SW_SAVE_EN_MASK) >> SLEEP_RETENTION_SW_SAVE_EN_LSB)
#define SLEEP_RETENTION_SW_SAVE_EN_SET(x)        (((x) << SLEEP_RETENTION_SW_SAVE_EN_LSB) & SLEEP_RETENTION_SW_SAVE_EN_MASK)
#define SLEEP_RETENTION_HW_SAVE_EN_MSB           11
#define SLEEP_RETENTION_HW_SAVE_EN_LSB           11
#define SLEEP_RETENTION_HW_SAVE_EN_MASK          0x00000800
#define SLEEP_RETENTION_HW_SAVE_EN_GET(x)        (((x) & SLEEP_RETENTION_HW_SAVE_EN_MASK) >> SLEEP_RETENTION_HW_SAVE_EN_LSB)
#define SLEEP_RETENTION_HW_SAVE_EN_SET(x)        (((x) << SLEEP_RETENTION_HW_SAVE_EN_LSB) & SLEEP_RETENTION_HW_SAVE_EN_MASK)
...
#define HOST_INT_MODE_ADDRESS                    0x000002ac
#define HOST_INT_MODE_OFFSET                     0x000002ac
#define HOST_INT_MODE_BIT_MSB                    1
#define HOST_INT_MODE_BIT_LSB                    0
#define HOST_INT_MODE_BIT_MASK                   0x00000003
#define HOST_INT_MODE_BIT_GET(x)                 (((x) & HOST_INT_MODE_BIT_MASK) >> HOST_INT_MODE_BIT_LSB)
#define HOST_INT_MODE_BIT_SET(x)                 (((x) << HOST_INT_MODE_BIT_LSB) & HOST_INT_MODE_BIT_MASK)

#define HOST_MODE_CFG_ADDRESS                    0x000002b0
#define HOST_MODE_CFG_OFFSET                     0x000002b0
#define HOST_MODE_CFG_WL_SDIO_EN_MSB             2
#define HOST_MODE_CFG_WL_SDIO_EN_LSB             2
#define HOST_MODE_CFG_WL_SDIO_EN_MASK            0x00000004
#define HOST_MODE_CFG_WL_SDIO_EN_GET(x)          (((x) & HOST_MODE_CFG_WL_SDIO_EN_MASK) >> HOST_MODE_CFG_WL_SDIO_EN_LSB)
#define HOST_MODE_CFG_WL_SDIO_EN_SET(x)          (((x) << HOST_MODE_CFG_WL_SDIO_EN_LSB) & HOST_MODE_CFG_WL_SDIO_EN_MASK)
#define HOST_MODE_CFG_WL_PCIE_EN_MSB             1
#define HOST_MODE_CFG_WL_PCIE_EN_LSB             1
#define HOST_MODE_CFG_WL_PCIE_EN_MASK            0x00000002
#define HOST_MODE_CFG_WL_PCIE_EN_GET(x)          (((x) & HOST_MODE_CFG_WL_PCIE_EN_MASK) >> HOST_MODE_CFG_WL_PCIE_EN_LSB)
#define HOST_MODE_CFG_WL_PCIE_EN_SET(x)          (((x) << HOST_MODE_CFG_WL_PCIE_EN_LSB) & HOST_MODE_CFG_WL_PCIE_EN_MASK)
#define HOST_MODE_CFG_WL_USB_EN_MSB              0
#define HOST_MODE_CFG_WL_USB_EN_LSB              0
#define HOST_MODE_CFG_WL_USB_EN_MASK             0x00000001
#define HOST_MODE_CFG_WL_USB_EN_GET(x)           (((x) & HOST_MODE_CFG_WL_USB_EN_MASK) >> HOST_MODE_CFG_WL_USB_EN_LSB)
#define HOST_MODE_CFG_WL_USB_EN_SET(x)           (((x) << HOST_MODE_CFG_WL_USB_EN_LSB) & HOST_MODE_CFG_WL_USB_EN_MASK)

#define CLK_REQ_FALL_EDGE_ADDRESS                0x000002b4
#define CLK_REQ_FALL_EDGE_OFFSET                 0x000002b4
...
#define TIME_B4_XTAL_SETTLED_ADDRESS             0x000002b8
#define TIME_B4_XTAL_SETTLED_OFFSET              0x000002b8
#define TIME_B4_XTAL_SETTLED_VAL_MSB             7
#define TIME_B4_XTAL_SETTLED_VAL_LSB             0
#define TIME_B4_XTAL_SETTLED_VAL_MASK            0x000000ff
#define TIME_B4_XTAL_SETTLED_VAL_GET(x)          (((x) & TIME_B4_XTAL_SETTLED_VAL_MASK) >> TIME_B4_XTAL_SETTLED_VAL_LSB)
#define TIME_B4_XTAL_SETTLED_VAL_SET(x)          (((x) << TIME_B4_XTAL_SETTLED_VAL_LSB) & TIME_B4_XTAL_SETTLED_VAL_MASK)

#define OTP_ADDRESS                              0x000002bc
#define OTP_OFFSET                               0x000002bc
...
#define OTP_STATUS_ADDRESS                       0x000002c0
#define OTP_STATUS_OFFSET                        0x000002c0
...
#define PMU_ADDRESS                              0x000002c4
#define PMU_OFFSET                               0x000002c4
...
#define PMU_CONFIG_ADDRESS                       0x000002c8
#define PMU_CONFIG_OFFSET                        0x000002c8
...
#define PMU_PAREG_ADDRESS                        0x000002cc
#define PMU_PAREG_OFFSET                         0x000002cc
...
#define PMU_BYPASS_ADDRESS                       0x000002d0
#define PMU_BYPASS_OFFSET                        0x000002d0
...
#define PMU_BYPASS_REG33_MSB                     0
#define PMU_BYPASS_REG33_LSB                     0
#define PMU_BYPASS_REG33_MASK                    0x00000001
#define PMU_BYPASS_REG33_GET(x)                  (((x) & PMU_BYPASS_REG33_MASK) >> PMU_BYPASS_REG33_LSB)
#define PMU_BYPASS_REG33_SET(x)                  (((x) << PMU_BYPASS_REG33_LSB) & PMU_BYPASS_REG33_MASK)
...
#define BB_PLL_CONFIG_ADDRESS                    0x000002f0
#define BB_PLL_CONFIG_OFFSET                     0x000002f0
...
#define USB_PHY_CONFIG_ADDRESS                   0x000002f4
#define USB_PHY_CONFIG_OFFSET                    0x000002f4
#define USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_MSB    9
#define USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_LSB    9
#define USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_MASK   0x00000200
#define USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_GET(x) (((x) & USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_MASK) >> USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_LSB)
#define USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_SET(x) (((x) << USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_LSB) & USB_PHY_CONFIG_HSIC_UTMI_ULPI_SEL_MASK)
#define USB_PHY_CONFIG_USB2_HSIC_SEL_MSB         8
#define USB_PHY_CONFIG_USB2_HSIC_SEL_LSB         8
#define USB_PHY_CONFIG_USB2_HSIC_SEL_MASK        0x00000100
#define USB_PHY_CONFIG_USB2_HSIC_SEL_GET(x)      (((x) & USB_PHY_CONFIG_USB2_HSIC_SEL_MASK) >> USB_PHY_CONFIG_USB2_HSIC_SEL_LSB)
#define USB_PHY_CONFIG_USB2_HSIC_SEL_SET(x)      (((x) << USB_PHY_CONFIG_USB2_HSIC_SEL_LSB) & USB_PHY_CONFIG_USB2_HSIC_SEL_MASK)
...
#define USB_PHY_CONFIG_EXT_PWR_SEQ_MSB           2
#define USB_PHY_CONFIG_EXT_PWR_SEQ_LSB           2
#define USB_PHY_CONFIG_EXT_PWR_SEQ_MASK          0x00000004
#define USB_PHY_CONFIG_EXT_PWR_SEQ_GET(x)        (((x) & USB_PHY_CONFIG_EXT_PWR_SEQ_MASK) >> USB_PHY_CONFIG_EXT_PWR_SEQ_LSB)
#define USB_PHY_CONFIG_EXT_PWR_SEQ_SET(x)        (((x) << USB_PHY_CONFIG_EXT_PWR_SEQ_LSB) & USB_PHY_CONFIG_EXT_PWR_SEQ_MASK)
...
#define USBCORE_CLK60M_ADDRESS                   0x000002f8
#define USBCORE_CLK60M_OFFSET                    0x000002f8
...
#define USBPHY_UTMI_CLK_ADDRESS                  0x000002fc
#define USBPHY_UTMI_CLK_OFFSET                   0x000002fc
...
#define USB_TXVALID_DLY_CONFIG_ADDRESS           0x00000300
#define USB_TXVALID_DLY_CONFIG_OFFSET            0x00000300
...
#define ENTERPRISE_CONFIG_ADDRESS                0x00000304
#define ENTERPRISE_CONFIG_OFFSET                 0x00000304
#define ENTERPRISE_CONFIG_SPEC_SCAN_PREC_MSB     15
#define ENTERPRISE_CONFIG_SPEC_SCAN_PREC_LSB     14
#define ENTERPRISE_CONFIG_SPEC_SCAN_PREC_MASK    0x0000c000
#define ENTERPRISE_CONFIG_SPEC_SCAN_PREC_GET(x)  (((x) & ENTERPRISE_CONFIG_SPEC_SCAN_PREC_MASK) >> ENTERPRISE_CONFIG_SPEC_SCAN_PREC_LSB)
#define ENTERPRISE_CONFIG_SPEC_SCAN_PREC_SET(x)  (((x) << ENTERPRISE_CONFIG_SPEC_SCAN_PREC_LSB) & ENTERPRISE_CONFIG_SPEC_SCAN_PREC_MASK)
#define ENTERPRISE_CONFIG_BT_DISABLE_MSB         13
#define ENTERPRISE_CONFIG_BT_DISABLE_LSB         13
#define ENTERPRISE_CONFIG_BT_DISABLE_MASK        0x00002000
#define ENTERPRISE_CONFIG_BT_DISABLE_GET(x)      (((x) & ENTERPRISE_CONFIG_BT_DISABLE_MASK) >> ENTERPRISE_CONFIG_BT_DISABLE_LSB)
#define ENTERPRISE_CONFIG_BT_DISABLE_SET(x)      (((x) << ENTERPRISE_CONFIG_BT_DISABLE_LSB) & ENTERPRISE_CONFIG_BT_DISABLE_MASK)
...
#define RTC_DEBUG_BUS_ADDRESS                    0x00000308
#define RTC_DEBUG_BUS_OFFSET                     0x00000308
...
#define RTC_EXT_CLK_BUF_ADDRESS                  0x0000030c
#define RTC_EXT_CLK_BUF_OFFSET                   0x0000030c
...
#define WLAN_AHB_BRIDGE_TIMEOUT_ADDRESS          0x00000310
#define WLAN_AHB_BRIDGE_TIMEOUT_OFFSET           0x00000310
...
#define WLAN_AHB_CONFIG_ADDRESS                  0x00000314
#define WLAN_AHB_CONFIG_OFFSET                   0x00000314
...
#define RTC_AXI_AHB_BRIDGE_ADDRESS               0x00000318
#define RTC_AXI_AHB_BRIDGE_OFFSET                0x00000318
...
#define WLAN_AO_GPIO_CONFIG_ADDRESS              0x0000031c
#define WLAN_AO_GPIO_CONFIG_OFFSET               0x0000031c
#define WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MSB 20
#define WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_LSB 20
#define WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MASK 0x00100000
#define WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MASK) >> WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_LSB) & WLAN_AO_GPIO_CONFIG_WLAN_JTAG_PIN_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_MSB  19
#define WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_LSB  19
#define WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_MASK 0x00080000
#define WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_MASK) >> WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_LSB) & WLAN_AO_GPIO_CONFIG_WLAN_LTE_PIN_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_MSB      18
#define WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_LSB      16
#define WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_MASK     0x00070000
#define WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_GET(x)   (((x) & WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_MASK) >> WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_LSB)
#define WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_SET(x)   (((x) << WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_LSB) & WLAN_AO_GPIO_CONFIG_DEBUG_SHIFT_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MSB  15
#define WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_LSB  15
#define WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MASK 0x00008000
#define WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO24_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MSB  14
#define WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_LSB  14
#define WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MASK 0x00004000
#define WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO23_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MSB  13
#define WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_LSB  13
#define WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MASK 0x00002000
#define WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO22_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MSB  12
#define WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_LSB  12
#define WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MASK 0x00001000
#define WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO21_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MSB  11
#define WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_LSB  11
#define WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MASK 0x00000800
#define WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO20_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MSB  10
#define WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_LSB  10
#define WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MASK 0x00000400
#define WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO19_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MSB  9
#define WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_LSB  9
#define WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MASK 0x00000200
#define WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO18_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MSB  8
#define WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_LSB  8
#define WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MASK 0x00000100
#define WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO16_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MSB  7
#define WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_LSB  7
#define WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MASK 0x00000080
#define WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO15_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MSB  6
#define WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_LSB  6
#define WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MASK 0x00000040
#define WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO14_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MSB  5
#define WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_LSB  5
#define WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MASK 0x00000020
#define WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO13_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MSB  4
#define WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_LSB  4
#define WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MASK 0x00000010
#define WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO11_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MSB  3
#define WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_LSB  3
#define WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MASK 0x00000008
#define WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO10_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MSB   2
#define WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_LSB   2
#define WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MASK  0x00000004
#define WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO8_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_MSB   1
#define WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_LSB   1
#define WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_MASK  0x00000002
#define WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO7_DEBUG_EN_MASK)
#define WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_MSB   0
#define WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_LSB   0
#define WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_MASK  0x00000001
#define WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_GET(x) (((x) & WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_MASK) >> WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_LSB)
#define WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_SET(x) (((x) << WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_LSB) & WLAN_AO_GPIO_CONFIG_GPIO6_DEBUG_EN_MASK)

#define WL_BT_GPIO_SWITCH_ADDRESS                0x00000320
#define WL_BT_GPIO_SWITCH_OFFSET                 0x00000320
#define WL_BT_GPIO_SWITCH_GPIO24_SWITCH_MSB      24
#define WL_BT_GPIO_SWITCH_GPIO24_SWITCH_LSB      24
#define WL_BT_GPIO_SWITCH_GPIO24_SWITCH_MASK     0x01000000
#define WL_BT_GPIO_SWITCH_GPIO24_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO24_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO24_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO24_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO24_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO24_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO23_SWITCH_MSB      23
#define WL_BT_GPIO_SWITCH_GPIO23_SWITCH_LSB      23
#define WL_BT_GPIO_SWITCH_GPIO23_SWITCH_MASK     0x00800000
#define WL_BT_GPIO_SWITCH_GPIO23_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO23_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO23_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO23_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO23_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO23_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO22_SWITCH_MSB      22
#define WL_BT_GPIO_SWITCH_GPIO22_SWITCH_LSB      22
#define WL_BT_GPIO_SWITCH_GPIO22_SWITCH_MASK     0x00400000
#define WL_BT_GPIO_SWITCH_GPIO22_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO22_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO22_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO22_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO22_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO22_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO21_SWITCH_MSB      21
#define WL_BT_GPIO_SWITCH_GPIO21_SWITCH_LSB      21
#define WL_BT_GPIO_SWITCH_GPIO21_SWITCH_MASK     0x00200000
#define WL_BT_GPIO_SWITCH_GPIO21_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO21_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO21_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO21_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO21_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO21_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO20_SWITCH_MSB      20
#define WL_BT_GPIO_SWITCH_GPIO20_SWITCH_LSB      20
#define WL_BT_GPIO_SWITCH_GPIO20_SWITCH_MASK     0x00100000
#define WL_BT_GPIO_SWITCH_GPIO20_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO20_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO20_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO20_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO20_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO20_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO19_SWITCH_MSB      19
#define WL_BT_GPIO_SWITCH_GPIO19_SWITCH_LSB      19
#define WL_BT_GPIO_SWITCH_GPIO19_SWITCH_MASK     0x00080000
#define WL_BT_GPIO_SWITCH_GPIO19_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO19_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO19_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO19_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO19_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO19_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO18_SWITCH_MSB      18
#define WL_BT_GPIO_SWITCH_GPIO18_SWITCH_LSB      18
#define WL_BT_GPIO_SWITCH_GPIO18_SWITCH_MASK     0x00040000
#define WL_BT_GPIO_SWITCH_GPIO18_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO18_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO18_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO18_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO18_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO18_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO17_SWITCH_MSB      17
#define WL_BT_GPIO_SWITCH_GPIO17_SWITCH_LSB      17
#define WL_BT_GPIO_SWITCH_GPIO17_SWITCH_MASK     0x00020000
#define WL_BT_GPIO_SWITCH_GPIO17_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO17_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO17_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO17_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO17_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO17_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO16_SWITCH_MSB      16
#define WL_BT_GPIO_SWITCH_GPIO16_SWITCH_LSB      16
#define WL_BT_GPIO_SWITCH_GPIO16_SWITCH_MASK     0x00010000
#define WL_BT_GPIO_SWITCH_GPIO16_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO16_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO16_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO16_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO16_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO16_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO15_SWITCH_MSB      15
#define WL_BT_GPIO_SWITCH_GPIO15_SWITCH_LSB      15
#define WL_BT_GPIO_SWITCH_GPIO15_SWITCH_MASK     0x00008000
#define WL_BT_GPIO_SWITCH_GPIO15_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO15_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO15_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO15_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO15_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO15_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO14_SWITCH_MSB      14
#define WL_BT_GPIO_SWITCH_GPIO14_SWITCH_LSB      14
#define WL_BT_GPIO_SWITCH_GPIO14_SWITCH_MASK     0x00004000
#define WL_BT_GPIO_SWITCH_GPIO14_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO14_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO14_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO14_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO14_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO14_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO13_SWITCH_MSB      13
#define WL_BT_GPIO_SWITCH_GPIO13_SWITCH_LSB      13
#define WL_BT_GPIO_SWITCH_GPIO13_SWITCH_MASK     0x00002000
#define WL_BT_GPIO_SWITCH_GPIO13_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO13_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO13_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO13_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO13_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO13_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO12_SWITCH_MSB      12
#define WL_BT_GPIO_SWITCH_GPIO12_SWITCH_LSB      12
#define WL_BT_GPIO_SWITCH_GPIO12_SWITCH_MASK     0x00001000
#define WL_BT_GPIO_SWITCH_GPIO12_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO12_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO12_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO12_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO12_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO12_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO11_SWITCH_MSB      11
#define WL_BT_GPIO_SWITCH_GPIO11_SWITCH_LSB      11
#define WL_BT_GPIO_SWITCH_GPIO11_SWITCH_MASK     0x00000800
#define WL_BT_GPIO_SWITCH_GPIO11_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO11_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO11_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO11_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO11_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO11_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO10_SWITCH_MSB      10
#define WL_BT_GPIO_SWITCH_GPIO10_SWITCH_LSB      10
#define WL_BT_GPIO_SWITCH_GPIO10_SWITCH_MASK     0x00000400
#define WL_BT_GPIO_SWITCH_GPIO10_SWITCH_GET(x)   (((x) & WL_BT_GPIO_SWITCH_GPIO10_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO10_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO10_SWITCH_SET(x)   (((x) << WL_BT_GPIO_SWITCH_GPIO10_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO10_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO9_SWITCH_MSB       9
#define WL_BT_GPIO_SWITCH_GPIO9_SWITCH_LSB       9
#define WL_BT_GPIO_SWITCH_GPIO9_SWITCH_MASK      0x00000200
#define WL_BT_GPIO_SWITCH_GPIO9_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO9_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO9_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO9_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO9_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO9_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO8_SWITCH_MSB       8
#define WL_BT_GPIO_SWITCH_GPIO8_SWITCH_LSB       8
#define WL_BT_GPIO_SWITCH_GPIO8_SWITCH_MASK      0x00000100
#define WL_BT_GPIO_SWITCH_GPIO8_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO8_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO8_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO8_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO8_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO8_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO7_SWITCH_MSB       7
#define WL_BT_GPIO_SWITCH_GPIO7_SWITCH_LSB       7
#define WL_BT_GPIO_SWITCH_GPIO7_SWITCH_MASK      0x00000080
#define WL_BT_GPIO_SWITCH_GPIO7_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO7_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO7_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO7_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO7_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO7_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO6_SWITCH_MSB       6
#define WL_BT_GPIO_SWITCH_GPIO6_SWITCH_LSB       6
#define WL_BT_GPIO_SWITCH_GPIO6_SWITCH_MASK      0x00000040
#define WL_BT_GPIO_SWITCH_GPIO6_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO6_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO6_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO6_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO6_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO6_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO5_SWITCH_MSB       5
#define WL_BT_GPIO_SWITCH_GPIO5_SWITCH_LSB       5
#define WL_BT_GPIO_SWITCH_GPIO5_SWITCH_MASK      0x00000020
#define WL_BT_GPIO_SWITCH_GPIO5_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO5_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO5_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO5_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO5_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO5_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO4_SWITCH_MSB       4
#define WL_BT_GPIO_SWITCH_GPIO4_SWITCH_LSB       4
#define WL_BT_GPIO_SWITCH_GPIO4_SWITCH_MASK      0x00000010
#define WL_BT_GPIO_SWITCH_GPIO4_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO4_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO4_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO4_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO4_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO4_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO3_SWITCH_MSB       3
#define WL_BT_GPIO_SWITCH_GPIO3_SWITCH_LSB       3
#define WL_BT_GPIO_SWITCH_GPIO3_SWITCH_MASK      0x00000008
#define WL_BT_GPIO_SWITCH_GPIO3_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO3_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO3_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO3_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO3_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO3_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO2_SWITCH_MSB       2
#define WL_BT_GPIO_SWITCH_GPIO2_SWITCH_LSB       2
#define WL_BT_GPIO_SWITCH_GPIO2_SWITCH_MASK      0x00000004
#define WL_BT_GPIO_SWITCH_GPIO2_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO2_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO2_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO2_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO2_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO2_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO1_SWITCH_MSB       1
#define WL_BT_GPIO_SWITCH_GPIO1_SWITCH_LSB       1
#define WL_BT_GPIO_SWITCH_GPIO1_SWITCH_MASK      0x00000002
#define WL_BT_GPIO_SWITCH_GPIO1_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO1_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO1_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO1_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO1_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO1_SWITCH_MASK)
#define WL_BT_GPIO_SWITCH_GPIO0_SWITCH_MSB       0
#define WL_BT_GPIO_SWITCH_GPIO0_SWITCH_LSB       0
#define WL_BT_GPIO_SWITCH_GPIO0_SWITCH_MASK      0x00000001
#define WL_BT_GPIO_SWITCH_GPIO0_SWITCH_GET(x)    (((x) & WL_BT_GPIO_SWITCH_GPIO0_SWITCH_MASK) >> WL_BT_GPIO_SWITCH_GPIO0_SWITCH_LSB)
#define WL_BT_GPIO_SWITCH_GPIO0_SWITCH_SET(x)    (((x) << WL_BT_GPIO_SWITCH_GPIO0_SWITCH_LSB) & WL_BT_GPIO_SWITCH_GPIO0_SWITCH_MASK)

#define MCI_PWR_ADDRESS                          0x00000324
#define MCI_PWR_OFFSET                           0x00000324
#define MCI_PWR_REMOTE_STATUS_MODE_MSB           5
#define MCI_PWR_REMOTE_STATUS_MODE_LSB           5
#define MCI_PWR_REMOTE_STATUS_MODE_MASK          0x00000020
#define MCI_PWR_REMOTE_STATUS_MODE_GET(x)        (((x) & MCI_PWR_REMOTE_STATUS_MODE_MASK) >> MCI_PWR_REMOTE_STATUS_MODE_LSB)
#define MCI_PWR_REMOTE_STATUS_MODE_SET(x)        (((x) << MCI_PWR_REMOTE_STATUS_MODE_LSB) & MCI_PWR_REMOTE_STATUS_MODE_MASK)
#define MCI_PWR_REMOTE_STATUS_TRIG_MSB           4
#define MCI_PWR_REMOTE_STATUS_TRIG_LSB           4
#define MCI_PWR_REMOTE_STATUS_TRIG_MASK          0x00000010
#define MCI_PWR_REMOTE_STATUS_TRIG_GET(x)        (((x) & MCI_PWR_REMOTE_STATUS_TRIG_MASK) >> MCI_PWR_REMOTE_STATUS_TRIG_LSB)
#define MCI_PWR_REMOTE_STATUS_TRIG_SET(x)        (((x) << MCI_PWR_REMOTE_STATUS_TRIG_LSB) & MCI_PWR_REMOTE_STATUS_TRIG_MASK)
#define MCI_PWR_REMOTE_STATUS_MSB                3
#define MCI_PWR_REMOTE_STATUS_LSB                3
#define MCI_PWR_REMOTE_STATUS_MASK               0x00000008
#define MCI_PWR_REMOTE_STATUS_GET(x)             (((x) & MCI_PWR_REMOTE_STATUS_MASK) >> MCI_PWR_REMOTE_STATUS_LSB)
#define MCI_PWR_REMOTE_STATUS_SET(x)             (((x) << MCI_PWR_REMOTE_STATUS_LSB) & MCI_PWR_REMOTE_STATUS_MASK)
#define MCI_PWR_REMOTE_STATUS_INT_EN_MSB         2
#define MCI_PWR_REMOTE_STATUS_INT_EN_LSB         2
#define MCI_PWR_REMOTE_STATUS_INT_EN_MASK        0x00000004
#define MCI_PWR_REMOTE_STATUS_INT_EN_GET(x)      (((x) & MCI_PWR_REMOTE_STATUS_INT_EN_MASK) >> MCI_PWR_REMOTE_STATUS_INT_EN_LSB)
#define MCI_PWR_REMOTE_STATUS_INT_EN_SET(x)      (((x) << MCI_PWR_REMOTE_STATUS_INT_EN_LSB) & MCI_PWR_REMOTE_STATUS_INT_EN_MASK)
#define MCI_PWR_REMOTE_REQ_WAKE_EN_MSB           1
#define MCI_PWR_REMOTE_REQ_WAKE_EN_LSB           1
#define MCI_PWR_REMOTE_REQ_WAKE_EN_MASK          0x00000002
#define MCI_PWR_REMOTE_REQ_WAKE_EN_GET(x)        (((x) & MCI_PWR_REMOTE_REQ_WAKE_EN_MASK) >> MCI_PWR_REMOTE_REQ_WAKE_EN_LSB)
#define MCI_PWR_REMOTE_REQ_WAKE_EN_SET(x)        (((x) << MCI_PWR_REMOTE_REQ_WAKE_EN_LSB) & MCI_PWR_REMOTE_REQ_WAKE_EN_MASK)
#define MCI_PWR_REQ_WAKE_MSB                     0
#define MCI_PWR_REQ_WAKE_LSB                     0
#define MCI_PWR_REQ_WAKE_MASK                    0x00000001
#define MCI_PWR_REQ_WAKE_GET(x)                  (((x) & MCI_PWR_REQ_WAKE_MASK) >> MCI_PWR_REQ_WAKE_LSB)
#define MCI_PWR_REQ_WAKE_SET(x)                  (((x) << MCI_PWR_REQ_WAKE_LSB) & MCI_PWR_REQ_WAKE_MASK)

#define PWD_TIME_ADDRESS                         0x00000328
#define PWD_TIME_OFFSET                          0x00000328
#define PWD_TIME_TOTAL_MSB                       23
#define PWD_TIME_TOTAL_LSB                       16
#define PWD_TIME_TOTAL_MASK                      0x00ff0000
#define PWD_TIME_TOTAL_GET(x)                    (((x) & PWD_TIME_TOTAL_MASK) >> PWD_TIME_TOTAL_LSB)
#define PWD_TIME_TOTAL_SET(x)                    (((x) << PWD_TIME_TOTAL_LSB) & PWD_TIME_TOTAL_MASK)
#define PWD_TIME_RAM_B_MSB                       15
#define PWD_TIME_RAM_B_LSB                       8
#define PWD_TIME_RAM_B_MASK                      0x0000ff00
#define PWD_TIME_RAM_B_GET(x)                    (((x) & PWD_TIME_RAM_B_MASK) >> PWD_TIME_RAM_B_LSB)
#define PWD_TIME_RAM_B_SET(x)                    (((x) << PWD_TIME_RAM_B_LSB) & PWD_TIME_RAM_B_MASK)
#define PWD_TIME_RAM_A_MSB                       7
#define PWD_TIME_RAM_A_LSB                       0
#define PWD_TIME_RAM_A_MASK                      0x000000ff
#define PWD_TIME_RAM_A_GET(x)                    (((x) & PWD_TIME_RAM_A_MASK) >> PWD_TIME_RAM_A_LSB)
#define PWD_TIME_RAM_A_SET(x)                    (((x) << PWD_TIME_RAM_A_LSB) & PWD_TIME_RAM_A_MASK)

#define PWR_ON_TIME_ADDRESS                      0x0000032c
#define PWR_ON_TIME_OFFSET                       0x0000032c
#define PWR_ON_TIME_RAM_B_MSB                    15
#define PWR_ON_TIME_RAM_B_LSB                    8
#define PWR_ON_TIME_RAM_B_MASK                   0x0000ff00
#define PWR_ON_TIME_RAM_B_GET(x)                 (((x) & PWR_ON_TIME_RAM_B_MASK) >> PWR_ON_TIME_RAM_B_LSB)
#define PWR_ON_TIME_RAM_B_SET(x)                 (((x) << PWR_ON_TIME_RAM_B_LSB) & PWR_ON_TIME_RAM_B_MASK)
#define PWR_ON_TIME_RAM_A_MSB                    7
#define PWR_ON_TIME_RAM_A_LSB                    0
#define PWR_ON_TIME_RAM_A_MASK                   0x000000ff
#define PWR_ON_TIME_RAM_A_GET(x)                 (((x) & PWR_ON_TIME_RAM_A_MASK) >> PWR_ON_TIME_RAM_A_LSB)
#define PWR_ON_TIME_RAM_A_SET(x)                 (((x) << PWR_ON_TIME_RAM_A_LSB) & PWR_ON_TIME_RAM_A_MASK)

#define PWR_CONTROL_ADDRESS                      0x00000330
#define PWR_CONTROL_OFFSET                       0x00000330
#define PWR_CONTROL_PWR_ON_TIME_TOTAL_MSB        13
#define PWR_CONTROL_PWR_ON_TIME_TOTAL_LSB        6
#define PWR_CONTROL_PWR_ON_TIME_TOTAL_MASK       0x00003fc0
#define PWR_CONTROL_PWR_ON_TIME_TOTAL_GET(x)     (((x) & PWR_CONTROL_PWR_ON_TIME_TOTAL_MASK) >> PWR_CONTROL_PWR_ON_TIME_TOTAL_LSB)
#define PWR_CONTROL_PWR_ON_TIME_TOTAL_SET(x)     (((x) << PWR_CONTROL_PWR_ON_TIME_TOTAL_LSB) & PWR_CONTROL_PWR_ON_TIME_TOTAL_MASK)
#define PWR_CONTROL_RAM_DS_PWD_MSB               5
#define PWR_CONTROL_RAM_DS_PWD_LSB               0
#define PWR_CONTROL_RAM_DS_PWD_MASK              0x0000003f
#define PWR_CONTROL_RAM_DS_PWD_GET(x)            (((x) & PWR_CONTROL_RAM_DS_PWD_MASK) >> PWR_CONTROL_RAM_DS_PWD_LSB)
#define PWR_CONTROL_RAM_DS_PWD_SET(x)            (((x) << PWR_CONTROL_RAM_DS_PWD_LSB) & PWR_CONTROL_RAM_DS_PWD_MASK)
...
typedef struct rtc_soc_reg_reg_s {
  ...
  volatile unsigned int diram_share_control;
  volatile unsigned int soc_clock_control;
  unsigned char pad1[4]; /* pad to 0x30 */
  ...
  volatile unsigned int pcie_l1ss_sleep_control;
  volatile unsigned int soc_int_sleep_mask;
  unsigned char pad2[4]; /* pad to 0xd4 */
  ...
  unsigned char pad6[20]; /* pad to 0x2a8 */
  volatile unsigned int chip_mode;
  volatile unsigned int host_int_mode;
  volatile unsigned int host_mode_cfg;
  volatile unsigned int clk_req_fall_edge;
  volatile unsigned int time_b4_xtal_settled;
  ...
  unsigned char pad7[8]; /* pad to 0x2dc */
  ...
  volatile unsigned int wlan_ao_gpio_config;
  volatile unsigned int wl_bt_gpio_switch;
  volatile unsigned int mci_pwr;
  volatile unsigned int pwd_time;
  volatile unsigned int pwr_on_time;
  volatile unsigned int pwr_control;
} rtc_soc_reg_reg_t;
#endif /* __ASSEMBLER__ */
