...
// File:       ./rtc_wlan_reg.h                                                
// Creator:    gcai                                                            
// Time:       Tuesday Aug 28, 2012 [3:41:07 pm]                               
//                                                                             
// Path:       /localtrees/gcai/tcai_local2/chips/rome/dev/ip/R1_IP5/rtl/rtc/blueprint
// Arguments:  /cad/denali/blueprint/3.7.3//Linux-64bit/blueprint -odir .      
//             -codegen ath_vrh.codegen -ath_vrh -ch -Wdesc -I                 
//             /localtrees/gcai/tcai_local2/chips/rome/dev/blueprint/sysconfig 
//             rtc_wlan_reg.rdl                                                
//                                                                             
// Sources:    /localtrees/gcai/tcai_local2/chips/rome/dev/ip/R1_IP5/rtl/rtc/blueprint/rtc_wlan_reg.rdl
//             /localtrees/gcai/tcai_local2/chips/rome/dev/env/blueprint/ath_vrh.pm
...
#define WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MSB             3
#define WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_LSB             3
#define WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MASK            0x00000008
#define WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_GET(x)          (((x) & WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MASK) >> WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_LSB)
#define WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_SET(x)          (((x) << WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_LSB) & WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_MASK)
#define WLAN_MAC_SLEEP_CONTROL_EBT_WMAC_SLEEP_ENABLE_RESET           0x1 // 1
...
// SW modifiable bits
#define WLAN_MAC_SLEEP_CONTROL_SW_MASK                               0x0000000f
// bits defined at reset
#define WLAN_MAC_SLEEP_CONTROL_RSTMASK                               0xffffffff
// reset value (ignore bits undefined at reset)
#define WLAN_MAC_SLEEP_CONTROL_RESET                                 0x0000000c
...
#define MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_MSB         27
#define MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_LSB         27
#define MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_MASK        0x08000000
#define MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_GET(x)      (((x) & MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_MASK) >> MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_LSB)
#define MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_SET(x)      (((x) << MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_LSB) & MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_MASK)
#define MAC_PCU_SLP32_MODE_SYNC_WB_CNT_ONLY_AFTER_WAKEUP_RESET       0x0 // 0
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_MSB        26
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_LSB        26
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_MASK       0x04000000
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_GET(x)     (((x) & MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_MASK) >> MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_LSB)
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_SET(x)     (((x) << MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_LSB) & MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_MASK)
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF2_ONLY_AFTER_WAKEUP_RESET      0x0 // 0
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_MSB         25
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_LSB         25
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_MASK        0x02000000
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_GET(x)      (((x) & MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_MASK) >> MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_LSB)
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_SET(x)      (((x) << MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_LSB) & MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_MASK)
#define MAC_PCU_SLP32_MODE_SYNC_TM_TSF_ONLY_AFTER_WAKEUP_RESET       0x0 // 0
...
// SW modifiable bits
#define MAC_PCU_SLP32_MODE_SW_MASK                                   0x0fffffff
// bits defined at reset
...
// 32'h0164 (MAC_PCU_LTE_COEX_CTRL)
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_MSB             15
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_LSB             8
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_MASK            0x0000ff00
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_GET(x)          (((x) & MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_MASK) >> MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_LSB)
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_SET(x)          (((x) << MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_LSB) & MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_MASK)
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_DELAY_RESET           0x40 // 64
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_MSB                   2
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_LSB                   2
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_MASK                  0x00000004
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_GET(x)                (((x) & MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_MASK) >> MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_LSB)
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_SET(x)                (((x) << MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_LSB) & MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_MASK)
#define MAC_PCU_LTE_COEX_CTRL_AUTO_ACTIVE_MASK_RESET                 0x0 // 0
#define MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_MSB                    1
#define MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_LSB                    1
#define MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_MASK                   0x00000002
#define MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_GET(x)                 (((x) & MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_MASK) >> MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_LSB)
#define MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_SET(x)                 (((x) << MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_LSB) & MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_MASK)
#define MAC_PCU_LTE_COEX_CTRL_RX_GRANT_ENABLE_RESET                  0x0 // 0
#define MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_MSB                    0
#define MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_LSB                    0
#define MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_MASK                   0x00000001
#define MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_GET(x)                 (((x) & MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_MASK) >> MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_LSB)
#define MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_SET(x)                 (((x) << MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_LSB) & MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_MASK)
#define MAC_PCU_LTE_COEX_CTRL_TX_GRANT_ENABLE_RESET                  0x0 // 0
#define MAC_PCU_LTE_COEX_CTRL_ADDRESS                                0x0164
#define MAC_PCU_LTE_COEX_CTRL_OFFSET                                 0x0164
// SW modifiable bits
#define MAC_PCU_LTE_COEX_CTRL_SW_MASK                                0x0000ff07
// bits defined at reset
#define MAC_PCU_LTE_COEX_CTRL_RSTMASK                                0xffffffff
// reset value (ignore bits undefined at reset)
#define MAC_PCU_LTE_COEX_CTRL_RESET                                  0x00004000
