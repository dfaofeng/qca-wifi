...
// File:       ./soc_pcie_reg.h                                                
// Creator:    ctsai                                                           
// Time:       Wednesday Jul 25, 2012 [4:02:05 pm]                             
//                                                                             
// Path:       /trees/ctsai/ctsai-dev1/chips/rome/dev/rtl/wlan/pcie_wrap/blueprint
// Arguments:  /cad/denali/blueprint/3.7.4//Linux-64bit/blueprint -odir .      
//             -codegen ath_vrh.codegen -ath_vrh -ch -Wdesc -I                 
//             /trees/ctsai/ctsai-dev1/chips/rome/dev/blueprint/sysconfig      
//             soc_pcie_reg.rdl                                                
//                                                                             
// Sources:    /trees/ctsai/ctsai-dev1/chips/rome/dev/rtl/wlan/pcie_wrap/blueprint/soc_pcie_reg.rdl
//             /trees/ctsai/ctsai-dev1/chips/rome/dev/env/blueprint/ath_vrh.pm 
//                                                                             
...
#define PCIE_CTRL_DBI_OVERRIDE_MASK                                  0x00020000
#define PCIE_CTRL_DBI_OVERRIDE_GET(x)                                (((x) & PCIE_CTRL_DBI_OVERRIDE_MASK) >> PCIE_CTRL_DBI_OVERRIDE_LSB)
#define PCIE_CTRL_DBI_OVERRIDE_SET(x)                                (((x) << PCIE_CTRL_DBI_OVERRIDE_LSB) & PCIE_CTRL_DBI_OVERRIDE_MASK)
#define PCIE_CTRL_DBI_OVERRIDE_RESET                                 0x0 // 0
...
// SW modifiable bits
#define PCIE_CTRL_SW_MASK                                            0x0003ffff
// bits defined at reset
...
#define PCIE_ELBI_DEBUG_DBGOTHER_MSB                                 31
#define PCIE_ELBI_DEBUG_DBGOTHER_LSB                                 26
#define PCIE_ELBI_DEBUG_DBGOTHER_MASK                                0xfc000000
#define PCIE_ELBI_DEBUG_DBGOTHER_GET(x)                              (((x) & PCIE_ELBI_DEBUG_DBGOTHER_MASK) >> PCIE_ELBI_DEBUG_DBGOTHER_LSB)
#define PCIE_ELBI_DEBUG_DBGOTHER_SET(x)                              (((x) << PCIE_ELBI_DEBUG_DBGOTHER_LSB) & PCIE_ELBI_DEBUG_DBGOTHER_MASK)
#define PCIE_ELBI_DEBUG_DBGOTHER_RESET                               0x0 // 0
...
// SW modifiable bits
#define PCIE_ELBI_DEBUG_SW_MASK                                      0xffffffff
// bits defined at reset
#define PCIE_ELBI_DEBUG_RSTMASK                                      0xffffffff
// reset value (ignore bits undefined at reset)
#define PCIE_ELBI_DEBUG_RESET                                        0x00000000

// 32'h0068 (PCIE_CTRL_OBS_MUX)
#define PCIE_CTRL_OBS_MUX_SEL_MSB                                    4
#define PCIE_CTRL_OBS_MUX_SEL_LSB                                    0
#define PCIE_CTRL_OBS_MUX_SEL_MASK                                   0x0000001f
#define PCIE_CTRL_OBS_MUX_SEL_GET(x)                                 (((x) & PCIE_CTRL_OBS_MUX_SEL_MASK) >> PCIE_CTRL_OBS_MUX_SEL_LSB)
#define PCIE_CTRL_OBS_MUX_SEL_SET(x)                                 (((x) << PCIE_CTRL_OBS_MUX_SEL_LSB) & PCIE_CTRL_OBS_MUX_SEL_MASK)
#define PCIE_CTRL_OBS_MUX_SEL_RESET                                  0x0 // 0
#define PCIE_CTRL_OBS_MUX_ADDRESS                                    0x0068
#define PCIE_CTRL_OBS_MUX_OFFSET                                     0x0068
// SW modifiable bits
#define PCIE_CTRL_OBS_MUX_SW_MASK                                    0x0000001f
// bits defined at reset
#define PCIE_CTRL_OBS_MUX_RSTMASK                                    0xffffffff
// reset value (ignore bits undefined at reset)
#define PCIE_CTRL_OBS_MUX_RESET                                      0x00000000

// 32'h0070 (PCIE_SCRATCH_0)
...
#define PCIE_SCRATCH_0_VAL_SET(x)                                    (((x) << PCIE_SCRATCH_0_VAL_LSB) & PCIE_SCRATCH_0_VAL_MASK)
#define PCIE_SCRATCH_0_VAL_RESET                                     0x0 // 0
#define PCIE_SCRATCH_0_ADDRESS                                       0x0070
#define PCIE_SCRATCH_0_OFFSET                                        0x0070
// SW modifiable bits
...
#define PCIE_SCRATCH_1_VAL_SET(x)                                    (((x) << PCIE_SCRATCH_1_VAL_LSB) & PCIE_SCRATCH_1_VAL_MASK)
#define PCIE_SCRATCH_1_VAL_RESET                                     0x0 // 0
#define PCIE_SCRATCH_1_ADDRESS                                       0x0074
#define PCIE_SCRATCH_1_OFFSET                                        0x0074
// SW modifiable bits
...
#define VMI_MSG_LOW_DATA_SET(x)                                      (((x) << VMI_MSG_LOW_DATA_LSB) & VMI_MSG_LOW_DATA_MASK)
#define VMI_MSG_LOW_DATA_RESET                                       0x0 // 0
#define VMI_MSG_LOW_ADDRESS                                          0x0078
#define VMI_MSG_LOW_OFFSET                                           0x0078
// SW modifiable bits
#define VMI_MSG_LOW_SW_MASK                                          0xffffffff
// bits defined at reset
#define VMI_MSG_LOW_RSTMASK                                          0xffffffff
// reset value (ignore bits undefined at reset)
#define VMI_MSG_LOW_RESET                                            0x00000000

// 32'h007c (VMI_MSG_HIGH)
...
#define VMI_MSG_HIGH_DATA_SET(x)                                     (((x) << VMI_MSG_HIGH_DATA_LSB) & VMI_MSG_HIGH_DATA_MASK)
#define VMI_MSG_HIGH_DATA_RESET                                      0x0 // 0
#define VMI_MSG_HIGH_ADDRESS                                         0x007c
#define VMI_MSG_HIGH_OFFSET                                          0x007c
// SW modifiable bits
#define VMI_MSG_HIGH_SW_MASK                                         0xffffffff
// bits defined at reset
#define VMI_MSG_HIGH_RSTMASK                                         0xffffffff
// reset value (ignore bits undefined at reset)
#define VMI_MSG_HIGH_RESET                                           0x00000000

// 32'h0080 (VMI_MSG_MISC)
...
#define VMI_MSG_MISC_DATA_SET(x)                                     (((x) << VMI_MSG_MISC_DATA_LSB) & VMI_MSG_MISC_DATA_MASK)
#define VMI_MSG_MISC_DATA_RESET                                      0x0 // 0
#define VMI_MSG_MISC_ADDRESS                                         0x0080
#define VMI_MSG_MISC_OFFSET                                          0x0080
// SW modifiable bits
#define VMI_MSG_MISC_SW_MASK                                         0xffffffff
// bits defined at reset
#define VMI_MSG_MISC_RSTMASK                                         0xffffffff
// reset value (ignore bits undefined at reset)
#define VMI_MSG_MISC_RESET                                           0x00000000
