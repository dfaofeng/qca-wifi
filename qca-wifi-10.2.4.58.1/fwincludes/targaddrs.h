...
/* host TX data swap support */
#define HOST_TX_DATASWAP() \
        (HOST_INTEREST->hi_txrx_dataswap & 0x01)

/* host RX data swap support */
#define HOST_RX_DATASWAP() \
        (HOST_INTEREST->hi_txrx_dataswap & 0x02)

/* ACK_POLICY change */
#define ACK_POLICY_11AC() \
        (HOST_INTEREST->hi_txrx_dataswap & 0x04)
...
#define AR6320_BOARD_DATA_SZ     7168
