...
static const COUNTRY_CODE_TO_ENUM_RD ahCmnAllCountries[] = {
    ...
    {CTRY_ANGUILLA,    ETSI1_WORLD,   "AI", "ANGUILLA",       YES,  NO, YES, YES, YES, YES, YES, 7000 },
    ...
    {CTRY_CHINA,       FCC2_WORLD,    "CN", "CHINA",          YES, YES, YES, YES, YES, YES, YES, 7000 },
    ...
    {CTRY_GUAM,        FCC3_FCCA,     "GU", "GUAM",           YES,  NO, YES, YES, YES, YES,  NO, 7000 },
    ...
    {CTRY_INDONESIA,   APL2_ETSIC,    "ID", "INDONESIA",      YES,  NO, YES, YES, NO, YES,  NO, 7000 },
...
{CTRY_MARSHALL_ISLANDS,  FCC3_FCCA, "MH", "MARSHALL ISLANDS", YES,  NO, YES, YES, YES, YES, YES, 7000 },
    ...
    {CTRY_MEXICO,      FCC3_WORLD,    "MX", "MEXICO",         YES, YES, YES, YES, YES, YES, YES, 7000 },
    {CTRY_MICRONESIA,  FCC3_FCCA,     "FM", "MICRONESIA",     YES, YES, YES, YES, YES, YES, YES, 7000 },
    {CTRY_MOLDOVA,     ETSI1_WORLD,   "MD", "MOLDOVA",        YES, YES, YES, YES, YES, YES, YES, 7000 },
    ...
    {CTRY_ST_BARTHELEMY, ETSI1_WORLD, "BL", "SAINT BARTHELEMY", YES,  NO, YES, YES, YES, YES, YES, 7000 },
    {CTRY_ST_KITTS_NEVIS, APL10_WORLD, "KN", "SAINT KITTS_NEVIS", YES,  NO,  NO, YES, YES, YES, YES, 7000 },
    {CTRY_ST_LUCIA,       APL10_WORLD, "LC", "SAINT LUCIA",       YES,  NO,  NO, YES, YES, YES, YES, 7000 },
    {CTRY_ST_MARTIN,     ETSI1_WORLD, "MF", "SAINT BARTHELEMY", YES,  NO, YES, YES, YES, YES, YES, 7000 },
    {CTRY_ST_PIERRE_MIQUELON, ETSI1_WORLD, "PM", "SAINT PIERRE MIQUELON", YES,  NO, YES, YES, YES, YES, YES, 7000 },
    {CTRY_ST_VINCENT_GRENADIENS, ETSI1_WORLD, "VC", "SAINT VINCENT GRENADIENS", YES,  NO, YES, YES, YES, YES, YES, 7000 },
    ...
    {CTRY_TURKS_CAICOS, FCC3_WORLD,   "TC", "TURKS CAICOS",   YES,  NO, YES, YES, YES, YES, YES, 7000 },
    ...
    {CTRY_UNITED_STATES_TDWR, FCC8_FCCA, "US", "UNITED STATES TDWR", YES, YES, YES, YES, YES, YES, YES, 7000 },
    ...
    {CTRY_WALLIS_FUTUNA, ETSI1_WORLD, "WF", "WALLIS FUTUNA",  YES,  NO, YES, YES, YES, YES, YES, 7000 },
