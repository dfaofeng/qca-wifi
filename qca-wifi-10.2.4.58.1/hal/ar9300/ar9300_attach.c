...
#define AR_SOC_SEL_25M_40M         0xB80600AC
            ...
            if (tmp_reg & 0x1) {
                ahp->clk_25mhz = 0;
                printf("Bootstrap clock 40MHz\n");
            } else {
                ahp->clk_25mhz = 1;
                printf("Bootstrap clock 25MHz\n");
            }
#else
...
#ifndef AR9340_EMULATION
    if (AR_SREV_WASP(ah) || AR_SREV_SCORPION(ah) || AR_SREV_DRAGONFLY(ah)) {
        /* check bootstrap clock setting */
#ifdef _WIN64
