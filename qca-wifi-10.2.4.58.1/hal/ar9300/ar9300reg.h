...
#define AR_CFG_HALT_REQ      0x00000800 // 11th bit REQ DMA HALT
#define AR_CFG_HALT_ACK      0x00001000 // 12th bit HALT ACK
...
#define AR_GPIO_OUTPUT_MUX_AS_SMART_ANT_SERIAL_STROBE      11
#define AR_GPIO_OUTPUT_MUX_AS_SMART_ANT_SERIAL_DATA        12
...
#define AR_ENT_OTP_LOCATION_DISABLE             0x00002000
#define AR_ENT_OTP_TXBF_DISABLE                 0x00008000
...
#define AR_PCU_MISC_MODE2_PROM_VC_MODE_DECOUPLE_DECRYPT 0xa948103b   /* Enable promiscous in azimuth mode 
																	 * decouple_decrypt flag(bit-27) is set*/
...
#define AR_USE_AD2_SEARCH               0x0000e000
#define AR_FIX_ENABLE_EV90734           0x00010000

#define AR_PROXY_STA_FIX3_ENABLE        0x00001000
#define AR_ENHANCE_FIX_ENABLE_EV90734   0x0000e000
#define AR_ADHOC_MCAST_SEARCH           0x80000000
...
//obsoleted, see EV84226
//#define AR_SREV_VERSION_JUPITER 0x20C0FF
#define AR_SREV_VERSION_JUPITER_10_EMU  0x28C1FF
#define AR_SREV_VERSION_JUPITER_20_EMU  0x2AF2FF
...
#define AR_SREV_REVISION_HONEYBEE_MASK        0xff    /* Honeybee revision mask */
#define AR_SREV_REVISION_APHRODITE_10         0      /* Aphrodite 1.0 */

#if defined(AH_SUPPORT_OSPREY)
#define AR_SREV_OSPREY(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_OSPREY))

#define AR_SREV_OSPREY_22(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_OSPREY) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_OSPREY_22))
#else
...
#define AR_SREV_AR9580(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_AR9580) && \
     (AH_PRIVATE((_ah))->ah_mac_rev >= AR_SREV_REVISION_AR9580_10))
...
#define AR_SREV_AR9580_10_OR_LATER(_ah) \
    (AR_SREV_AR9580(_ah) || AR_SREV_SCORPION(_ah) || AR_SREV_HONEYBEE(_ah) || AR_SREV_DRAGONFLY(_ah))

#define AR_SREV_JUPITER(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_JUPITER))

#define AR_SREV_JUPITER_10(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_JUPITER) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_JUPITER_10))

#define AR_SREV_JUPITER_20(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_JUPITER) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_JUPITER_20))
...
#define AR_SREV_APHRODITE(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_APHRODITE))

#define AR_SREV_APHRODITE_10(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_APHRODITE) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_APHRODITE_10))

#if defined(AH_SUPPORT_HORNET)
#define AR_SREV_HORNET_10(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_HORNET) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_HORNET_10))

#define AR_SREV_HORNET_11(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_HORNET) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_HORNET_11))

#define AR_SREV_HORNET_12(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_HORNET) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_HORNET_12))
...
#define AR_SREV_WASP(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_WASP))
#else
...
#define AR_SREV_HONEYBEE_11_OR_LATER(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_HONEYBEE) && \
     (AH_PRIVATE((_ah))->ah_mac_rev >= AR_SREV_REVISION_HONEYBEE_11))
#define AR_SREV_HONEYBEE_20(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_HONEYBEE) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_HONEYBEE_20))
#else
#define AR_SREV_HONEYBEE(_ah)                                         0
#define AR_SREV_HONEYBEE_10(_ah) 0
#define AR_SREV_HONEYBEE_11(_ah) 0
#define AR_SREV_HONEYBEE_11_OR_LATER(_ah) 0
#define AR_SREV_HONEYBEE_20(_ah) 0
#endif /* #if defined(AH_SUPPORT_HONEYBEE) */

#define AR_SREV_WASP_10(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_WASP) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_WASP_10))

#define AR_SREV_WASP_11(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_WASP) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_WASP_11))

#define AR_SREV_WASP_12(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_WASP) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_WASP_12))

#if defined(AH_SUPPORT_SCORPION)
#define AR_SREV_SCORPION(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_SCORPION))
#else
#define AR_SREV_SCORPION(_ah) 0
#endif /* #if defined(AH_SUPPORT_SCORPION) */

#if defined(AH_SUPPORT_DRAGONFLY)
#define AR_SREV_DRAGONFLY(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_DRAGONFLY))
#else
#define AR_SREV_DRAGONFLY(_ah) 0
#endif /* #if defined(AH_SUPPORT_DRAGONFLY) */

#if defined(AH_SUPPORT_POSEIDON)
#define AR_SREV_POSEIDON(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_POSEIDON))

#define AR_SREV_POSEIDON_10(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_POSEIDON) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_POSEIDON_10))

#define AR_SREV_POSEIDON_11(_ah) \
    ((AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_POSEIDON) && \
     (AH_PRIVATE((_ah))->ah_mac_rev == AR_SREV_REVISION_POSEIDON_11))
#else
...
#define AR_SREV_POSEIDON_OR_LATER(_ah) \
    (AH_PRIVATE((_ah))->ah_mac_version >= AR_SREV_VERSION_POSEIDON)
#define AR_SREV_SOC(_ah) (AR_SREV_HORNET(_ah) || AR_SREV_POSEIDON(_ah) || AR_SREV_WASP(_ah) || AR_SREV_HONEYBEE(_ah) || AR_SREV_DRAGONFLY(_ah))
/*
