...
tx99_ioctl(ath_dev_t device, struct ath_softc *sc, int cmd, void *addr)
{
    ...
    switch(i_req.type){
        ...
        case TX99_WCMD_SET_TESTMODE:
            adf_os_print("tx99_ioctl command : testmode %d\n",i_req.data.testmode);
