 ...
 * 
 */
int ath_host_attach(struct ath_softc_net80211 *scn, a_uint16_t devid)
{
                      ...
                      const struct usb_device_id *id)
{
    ...
    int result = 0;
    a_uint8_t* Image;
    a_uint32_t ImageSize;    
    a_uint16_t devid = 0x23;
    int i;
    int thread_create = 0;
    ...
    /* allocate net devie */
    net = alloc_netdev(sizeof(struct ath_usb_softc), "radio%d", NET_NAME_UNKNOWN, ether_setup);
    if (net == NULL) {
    ...
    if (aps_usb_sc->aps_osdev.isMagpie == 1)
    {
        ...
        {
            Image = (a_uint8_t *)usbFwImageMagpie_1_1;
            ImageSize = (a_uint32_t)usbFwImageMagpie_1_1_Size;
        }
        else
        {
            Image = (a_uint8_t *)usbFwImageMagpie;
            ImageSize = (a_uint32_t)usbFwImageMagpieSize;
        }
    } 
    else 
    {
        Image = (a_uint8_t *)usbFwImage;
        ImageSize = (a_uint32_t)usbFwImageSize;
    }
