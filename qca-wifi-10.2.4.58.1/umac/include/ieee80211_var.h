...
#define IEEE80211_BINTVAL_MBSSID_MIN 100
...
#define VHT_MCSMAP_NSS2_MCS0_7  0xfff0  /* NSS=1 MCS 0-7, NSS=2       MCS 0-7, NSS=3 not supported */
#define VHT_MCSMAP_NSS3_MCS0_7  0xffc0  /* NSS=1 MCS 0-7, NSS=2       MCS 0-7, NSS=3       MCS 0-7 */
...
#define VHT_MCSMAP_NSS3_MCS0_8  0xffd5  /* NSS=1 MCS 0-8, NSS=2       MCS 0-8, NSS=3       MCS 0-8 */
...
#define VHT_MCSMAP_NSS1_MCS0_9_NSS2_MCS0_9_NSS3_MCS0_7  0xffca  /* NSS=1 MCS 0-9, NSS=2 MCS 0-9, NSS=3 MCS 0-7 */
...
#ifdef CONFIG_SMP
typedef rwlock_t ieee80211_vap_list_lock_t;
#define IEEE80211_VAP_LIST_LOCK_INIT(_p_lock)               OS_RWLOCK_INIT(_p_lock)
#define IEEE80211_VAP_LIST_LOCK_DESTROY(_p_lock)            OS_RWLOCK_DESTROY(_p_lock)
#define IEEE80211_VAP_LIST_LOCK_DECLARE_AND_RESET_VAR(_flags) unsigned long _flags = 0
#define IEEE80211_VAP_LIST_READ_LOCK(_p_lock , _p_state)    OS_RWLOCK_READ_LOCK(_p_lock , _p_state)
#define IEEE80211_VAP_LIST_READ_UNLOCK(_p_lock , _p_state)  OS_RWLOCK_READ_UNLOCK(_p_lock , _p_state)
#define IEEE80211_VAP_LIST_WRITE_LOCK_IRQSAVE(_p_lock , _p_state, _flags)   OS_RWLOCK_WRITE_LOCK_IRQSAVE(_p_lock , _p_state, _flags)
#define IEEE80211_VAP_LIST_WRITE_UNLOCK_IRQRESTORE(_p_lock , _p_state, _flags)  OS_RWLOCK_WRITE_UNLOCK_IRQRESTORE(_p_lock , _p_state, _flags)
#endif
...
struct atf_config {
    struct {
        ...
        u_int32_t    sta_cfg_value;     /* user config % for sta*/
...
#define IC_IEEE80211_FIND_NODE(_ic,_nt,_macaddr)  (_ic)->ic_ieee80211_find_node_debug((_nt),(_macaddr), __FUNCTION__, __LINE__)
    struct  ieee80211_node*  (*ic_ieee80211_find_node_debug)(struct ieee80211_node_table *nt, const u_int8_t *macaddr, const char * func, int line);
#else
...
#define MAX_TX_PPDU_SIZE 32
    ...
    u_int8_t                      ic_def_bintval_override;
...
#if UNIFIED_SMARTANTENNA
    void (*ic_smart_ant_enable) (struct ieee80211com *ic, int enable, int mode, int rx_antenna);
    void (*ic_smart_ant_set_rx_antenna) (struct ieee80211com *ic, u_int32_t antenna);
    void (*ic_smart_ant_set_tx_antenna) (struct ieee80211_node *ni, u_int32_t *antenna_array);
    void (*ic_smart_ant_set_tx_default_antenna) (struct ieee80211com *ic, u_int32_t antenna);
    void (*ic_smart_ant_set_training_info) (struct ieee80211_node *ni, uint32_t *rate_array, uint32_t *antenna_array, uint32_t numpkts);
    void (*ic_smart_ant_prepare_rateset)(struct ieee80211com *ic, struct ieee80211_node *ni);
    void (*ic_smart_ant_set_node_config_ops) (struct ieee80211_node *ni, uint32_t cmd_id, uint16_t args_count, u_int32_t args_arr[]);
...
#define ATH_HMMC_CNT_MAX 8
    ...
    int         (*ic_add_hmmc) (struct ieee80211vap *vap, u_int32_t ip, u_int32_t mask);
    int         (*ic_del_hmmc) (struct ieee80211vap *vap, u_int32_t ip, u_int32_t mask);
	void 		(*ic_get_ald_statistics)(struct ieee80211vap *vap);
...
#endif
    void                             (*ic_get_ext_chan_info)(struct ieee80211com *ic, struct ieee80211_channel_list *chan);
	...
	int 				    (*ic_checkandplumb_key)(struct ieee80211vap *vap, struct ieee80211_node *ni, const u_int8_t peermac[IEEE80211_ADDR_LEN]);
        void                                (*ic_print_key_error)(struct ieee80211com *ic, u_int8_t val);
#endif
    ...
    void                                (*ic_notify_buffull)(struct ieee80211com *ic);
...
/* multiple thread safe */
    ...
    systime_t                         iv_lastbcn;                 /* absolute system time; not TSF */
    ...
    u_int8_t                          iv_tx_encap_type;       /* per VAP tx encap mode - should be used
...
#endif
    u_int32_t                  auth_req_cnt;
    u_int32_t                  deauth_req_cnt;
    u_int32_t                  assoc_req_cnt;
    u_int32_t                  disassoc_req_cnt;
