...
struct ieee80211_channel* find_proper_chan(struct ieee80211com *ic, struct ieee80211_channel *c1, struct ieee80211_channel *c2);
...
#define CWMASK  (IEEE80211_CHAN_HT40MINUS | IEEE80211_CHAN_HT40PLUS | IEEE80211_CHAN_HT20 | IEEE80211_CHAN_OFDM)
    ...
    int counter = 0;
    u_int32_t c1flags = c1->ic_flags;
    u_int32_t c2flags = c2->ic_flags;
    u_int32_t addflag;
    ...
    channel = ieee80211_find_channel(ic, c1->ic_freq, c1flags | addflag);
