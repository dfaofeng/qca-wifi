...
static wlan_if_t _ieee80211_scan_get_vap(ieee80211_scanner_t ss)
{
    return ss->ss_vap;
}
...
static int _ieee80211_scan_cancel(ieee80211_scanner_t       ss,
                     IEEE80211_SCAN_REQUESTOR requestor,
                          ...
                          bool (*is_sw_txq_empty)    (wlan_dev_t))
{
    ...
    *ss = (ieee80211_scanner_t) OS_MALLOC(osdev, sizeof(struct ieee80211_scanner), 0);
    if (*ss) {
        ...
        (*ss)->ss_common.scan_get_vap = _ieee80211_scan_get_vap;
